...
This curated list contains 400 awesome open-source projects with a total of 2.1M stars grouped into 28 categories. All projects are ranked by a project-quality score, which is calculated based on various metrics automatically collected from GitHub and different package managers. If you like to add or update projects, feel free to open an [issue](https://github.com/ml-tooling/best-of-python/issues/new/choose) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10, submit a [pull request](https://github.com/ml-tooling/best-of-python/pulls) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10, or directly edit the [projects.yaml](https://github.com/ml-tooling/best-of-python/edit/main/projects.yaml) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10. Contributions are very welcome!
...
* [GitHub](https://github.com/protocolbuffers/protobuf) ⭐ 72,018 | 🐛 331 | 🌐 C++ | 📅 2026-09-10 (👨‍💻 1.5K · 🔀 16K · 📦 1M):

  ```
  git clone https://github.com/protocolbuffers/protobuf
  ```
* [PyPi](https://pypi.org/project/protobuf) (📥 740M / month · 📦 13K · ⏱️ 31.08.2026):
  ```
  pip install protobuf
  ```
* [Conda](https://anaconda.org/conda-forge/protobuf) (📥 35M · ⏱️ 06.09.2026):
  ```
  conda install -c conda-forge protobuf
  ```
* [npm](https://www.npmjs.com/package/google-protobuf) (📥 24M / month · 📦 3.8K · ⏱️ 24.02.2026):
  ```
...
* [GitHub](https://github.com/google/flatbuffers) ⭐ 26,450 | 🐛 287 | 🌐 C++ | 📅 2026-08-11 (👨‍💻 780 · 🔀 3.7K · 📦 200K):

  ```
  git clone https://github.com/google/flatbuffers
  ```
* [PyPi](https://pypi.org/project/flatbuffers) (📥 84M / month · 📦 700 · ⏱️ 19.12.2025):
  ```
  pip install flatbuffers
  ```
* [Conda](https://anaconda.org/conda-forge/flatbuffers) (📥 2.5M · ⏱️ 22.12.2025):
  ```
...
* [GitHub](https://github.com/ijl/orjson) ⭐ 8,227 | 🐛 0 | 🌐 Python | 📅 2026-08-31 (👨‍💻 24 · 🔀 320 · 📦 230K):

  ```
  git clone https://github.com/ijl/orjson
  ```
* [PyPi](https://pypi.org/project/orjson) (📥 210M / month · 📦 7.3K · ⏱️ 14.08.2026):
  ```
  pip install orjson
  ```
* [Conda](https://anaconda.org/conda-forge/orjson) (📥 7.3M · ⏱️ 16.08.2026):
  ```
...
* [GitHub](https://github.com/marshmallow-code/marshmallow) ⭐ 7,238 | 🐛 151 | 🌐 Python | 📅 2026-09-08 (👨‍💻 230 · 🔀 720 · 📦 230K):

  ```
  git clone https://github.com/marshmallow-code/marshmallow
  ```
* [PyPi](https://pypi.org/project/marshmallow) (📥 100M / month · 📦 2.9K · ⏱️ 08.08.2026):
  ```
...
* [GitHub](https://github.com/uqfoundation/dill) ⭐ 2,449 | 🐛 208 | 🌐 Python | 📅 2026-09-05 (👨‍💻 51 · 🔀 190 · 📦 250K):

  ```
  git clone https://github.com/uqfoundation/dill
  ```
* [PyPi](https://pypi.org/project/dill) (📥 180M / month · 📦 4.2K · ⏱️ 19.01.2026):
  ```
  pip install dill
  ```
* [Conda](https://anaconda.org/conda-forge/dill) (📥 21M · ⏱️ 19.01.2026):
  ```
...
* [GitHub](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 15 | 🌐 Python | 📅 2026-08-29 (👨‍💻 52 · 🔀 360 · 📦 150K):

  ```
  git clone https://github.com/simplejson/simplejson
  ```
* [PyPi](https://pypi.org/project/simplejson) (📥 49M / month · 📦 3K · ⏱️ 27.08.2026):
  ```
  pip install simplejson
  ```
* [Conda](https://anaconda.org/conda-forge/simplejson) (📥 5.6M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/cloudpipe/cloudpickle) ⭐ 1,940 | 🐛 109 | 🌐 Python | 📅 2026-09-10 (👨‍💻 81 · 🔀 200 · 📦 170K):
...
* [PyPi](https://pypi.org/project/cloudpickle) (📥 150M / month · 📦 2.3K · ⏱️ 03.11.2025):
  ...
  ```
* [Conda](https://anaconda.org/conda-forge/cloudpickle) (📥 38M · ⏱️ 09.12.2025):
  ```
...
* [GitHub](https://github.com/etingof/pyasn1) ⭐ 256 | 🐛 61 | 🌐 Python | 📅 2023-11-21 (👨‍💻 16 · 🔀 120 · 📦 710K):
  ...
  ```
* [PyPi](https://pypi.org/project/pyasn1) (📥 480M / month · 📦 2.4K · ⏱️ 09.07.2026):
  ```
  pip install pyasn1
  ```
* [Conda](https://anaconda.org/conda-forge/pyasn1) (📥 24M · ⏱️ 09.07.2026):
  ```
...
* [GitHub](https://github.com/jsonpickle/jsonpickle) ⭐ 1,318 | 🐛 28 | 🌐 Python | 📅 2026-09-08 (👨‍💻 90 · 🔀 180 · 📦 51K):

  ```
  git clone https://github.com/jsonpickle/jsonpickle
  ```
* [PyPi](https://pypi.org/project/jsonpickle) (📥 17M / month · 📦 1.6K · ⏱️ 28.05.2026):
  ```
...
* [GitHub](https://github.com/python-rapidjson/python-rapidjson) ⭐ 531 | 🐛 20 | 🌐 C++ | 📅 2026-09-06 (👨‍💻 26 · 🔀 53 · 📦 8.1K):

  ```
  git clone https://github.com/python-rapidjson/python-rapidjson
  ```
* [PyPi](https://pypi.org/project/python-rapidjson) (📥 3.9M / month · 📦 300 · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/explosion/srsly) ⭐ 486 | 🐛 9 | 🌐 Python | 📅 2026-03-27 (👨‍💻 16 · 🔀 37 · 📦 70K):

  ```
  git clone https://github.com/explosion/srsly
  ```
* [PyPi](https://pypi.org/project/srsly) (📥 23M / month · 📦 270 · ⏱️ 23.03.2026):
  ```
  pip install srsly
  ```
...
* [GitHub](https://github.com/telegraphic/hickle) ⭐ 503 | 🐛 2 | 🌐 Python | 📅 2026-08-06 (👨‍💻 29 · 🔀 70 · 📦 1.1K):
  ...
  ```
* [PyPi](https://pypi.org/project/hickle) (📥 45K / month · 📦 39 · ⏱️ 30.03.2024):
  ```
  pip install hickle
  ```
* [Conda](https://anaconda.org/conda-forge/hickle) (📥 43K · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/samuelcolvin/rtoml) ⭐ 406 | 🐛 11 | 🌐 Python | 📅 2026-06-12 (👨‍💻 16 · 🔀 30 · 📦 980):

  ```
  git clone https://github.com/samuelcolvin/rtoml
  ```
* [PyPi](https://pypi.org/project/rtoml) (📥 1.1M / month · 📦 160 · ⏱️ 19.10.2025):
  ```
  pip install rtoml
  ```
...
* <b>[ultrajson](https://github.com/ultrajson/ultrajson) ⭐ 4,497 | 🐛 31 | 🌐 C++ | 📅 2026-09-04</b> (🥉27 ·  ⭐ 4.5K) - Ultra fast JSON decoder and encoder written in C with Python.. <code>❗Unlicensed</code>
* <b>[msgpack](https://github.com/msgpack/msgpack-python) ⭐ 2,102 | 🐛 15 | 🌐 Python | 📅 2026-09-07</b> (🥉29 ·  ⭐ 2.1K) - MessagePack serializer implementation for Python.. <code>❗Unlicensed</code>
* <b>[pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26</b> (🥉21 ·  ⭐ 710) - Python bindings for the simdjson project. <code>❗Unlicensed</code>
...
* [GitHub](https://github.com/pandas-dev/pandas) ⭐ 49,710 | 🐛 2,728 | 🌐 Python | 📅 2026-09-10 (👨‍💻 4.3K · 🔀 20K · 📦 2.9M):

  ```
  git clone https://github.com/pandas-dev/pandas
  ```
* [PyPi](https://pypi.org/project/pandas) (📥 630M / month · 📦 130K · ⏱️ 22.07.2026):
  ```
  pip install pandas
  ```
* [Conda](https://anaconda.org/conda-forge/pandas) (📥 95M · ⏱️ 28.07.2026):
  ```
...
* [GitHub](https://github.com/pola-rs/polars) ⭐ 39,704 | 🐛 2,880 | 🌐 Rust | 📅 2026-09-10 (👨‍💻 760 · 🔀 3.1K · 📦 37K):

  ```
  git clone https://github.com/pola-rs/polars
  ```
* [PyPi](https://pypi.org/project/polars) (📥 62M / month · 📦 8K · ⏱️ 09.09.2026):
  ```
  pip install polars
  ```
...
* [GitHub](https://github.com/h5py/h5py) ⭐ 2,250 | 🐛 343 | 🌐 Python | 📅 2026-09-08 (👨‍💻 220 · 🔀 560 · 📦 360K):

  ```
  git clone https://github.com/h5py/h5py
  ```
* [PyPi](https://pypi.org/project/h5py) (📥 32M / month · 📦 11K · ⏱️ 06.03.2026):
  ```
  pip install h5py
  ```
...
* [GitHub](https://github.com/pydata/xarray) ⭐ 4,196 | 🐛 1,442 | 🌐 Python | 📅 2026-09-09 (👨‍💻 640 · 🔀 1.3K · 📦 46K):

  ```
  git clone https://github.com/pydata/xarray
  ```
* [PyPi](https://pypi.org/project/xarray) (📥 14M / month · 📦 6.3K · ⏱️ 09.07.2026):
  ```
  pip install xarray
  ```
...
* [GitHub](https://github.com/pydata/numexpr) ⭐ 2,538 | 🐛 4 | 🌐 Python | 📅 2026-08-31 (👨‍💻 90 · 🔀 230 · 📦 100K):

  ```
  git clone https://github.com/pydata/numexpr
  ```
* [PyPi](https://pypi.org/project/numexpr) (📥 14M / month · 📦 1.3K · ⏱️ 18.07.2026):
  ```
  pip install numexpr
  ```
* [Conda](https://anaconda.org/conda-forge/numexpr) (📥 15M · ⏱️ 18.07.2026):
  ```
...
* [GitHub](https://github.com/zarr-developers/zarr-python) ⭐ 2,052 | 🐛 521 | 🌐 Python | 📅 2026-09-10 (👨‍💻 190 · 🔀 440 · 📦 9K):

  ```
  git clone https://github.com/zarr-developers/zarr-python
  ```
* [PyPi](https://pypi.org/project/zarr) (📥 5.6M / month · 📦 2.5K · ⏱️ 30.07.2026):
  ```
  pip install zarr
  ```
* [Conda](https://anaconda.org/conda-forge/zarr) (📥 6.5M · ⏱️ 31.07.2026):
  ```
...
* [GitHub](https://github.com/msiemens/tinydb) ⭐ 7,562 | 🐛 12 | 🌐 Python | 📅 2026-08-10 (👨‍💻 100 · 🔀 620 · 📦 16K):

  ```
  git clone https://github.com/msiemens/tinydb
  ```
* [PyPi](https://pypi.org/project/tinydb) (📥 3.7M / month · 📦 910 · ⏱️ 06.08.2026):
  ```
  pip install tinydb
  ```
...
* [GitHub](https://github.com/ekzhu/datasketch) ⭐ 2,964 | 🐛 58 | 🌐 Python | 📅 2026-08-09 (👨‍💻 39 · 🔀 320 · 📦 2.6K):

  ```
  git clone https://github.com/ekzhu/datasketch
  ```
* [PyPi](https://pypi.org/project/datasketch) (📥 4.9M / month · 📦 220 · ⏱️ 05.07.2026):
  ```
...
* [GitHub](https://github.com/pydata/bottleneck) ⭐ 1,181 | 🐛 61 | 🌐 Python | 📅 2026-09-09 (👨‍💻 42 · 🔀 120 · 📦 60K):

  ```
  git clone https://github.com/pydata/bottleneck
  ```
* [PyPi](https://pypi.org/project/Bottleneck) (📥 8.8M / month · 📦 780 · ⏱️ 25.07.2026):
  ```
  pip install Bottleneck
  ```
* [Conda](https://anaconda.org/conda-forge/bottleneck) (📥 7.6M · ⏱️ 10.11.2025):
  ```
...
* [GitHub](https://github.com/modin-project/modin) ⭐ 10,392 | 🐛 715 | 🌐 Python | 📅 2026-02-10 (👨‍💻 140 · 🔀 660 · 📦 2.3K):

  ```
  git clone https://github.com/modin-project/modin
  ```
* [PyPi](https://pypi.org/project/modin) (📥 1.2M / month · 📦 66 · ⏱️ 02.10.2025):
  ```
  pip install modin
  ```
...
* [GitHub](https://github.com/PyTables/PyTables) ⭐ 1,372 | 🐛 153 | 🌐 Python | 📅 2026-09-01 (👨‍💻 150 · 🔀 280):

  ```
  git clone https://github.com/PyTables/PyTables
  ```
* [PyPi](https://pypi.org/project/tables) (📥 2.6M / month · 📦 1.8K · ⏱️ 01.03.2026):
  ```
  pip install tables
  ```
...
* [GitHub](https://github.com/vaexio/vaex) ⭐ 8,509 | 🐛 552 | 🌐 Python | 📅 2026-04-01 (👨‍💻 76 · 🔀 600 · 📦 1K):
  ...
  ```
* [PyPi](https://pypi.org/project/vaex) (📥 13K / month · 📦 68 · ⏱️ 03.02.2026):
  ```
  pip install vaex
  ```
* [Conda](https://anaconda.org/conda-forge/vaex) (📥 650K · ⏱️ 22.04.2025):
  ```
...
* [GitHub](https://github.com/h2oai/datatable) ⭐ 1,876 | 🐛 183 | 🌐 C++ | 📅 2026-09-01 (👨‍💻 42 · 🔀 160):

  ```
  git clone https://github.com/h2oai/datatable
  ```
* [PyPi](https://pypi.org/project/datatable) (📥 26K / month · 📦 54 · ⏱️ 01.12.2023):
  ```
  pip install datatable
  ```
* [Conda](https://anaconda.org/conda-forge/datatable) (📥 63K · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/patx/pickledb) ⭐ 1,070 | 🐛 18 | 🌐 Python | 📅 2026-05-10 (👨‍💻 17 · 🔀 130 · 📦 3.4K):

  ```
  git clone https://github.com/patx/pickledb
  ```
* [PyPi](https://pypi.org/project/pickledb) (📥 26K / month · 📦 8 · ⏱️ 05.01.2026):
  ```
...
* [GitHub]() (👨‍💻 31 · 🔀 38 · 📦 33):
  ...
  ```
* [PyPi](https://pypi.org/project/static-frame) (📥 6.1K / month · 📦 6 · ⏱️ 11.08.2026):
  ```
  pip install static-frame
  ```
* [Conda](https://anaconda.org/conda-forge/static-frame) (📥 660K · ⏱️ 07.07.2026):
  ```
...
* <b>[numpy](https://github.com/numpy/numpy) ⭐ 32,710 | 🐛 2,297 | 🌐 Python | 📅 2026-09-10</b> (🥇38 ·  ⭐ 33K) - The fundamental package for scientific computing with Python. <code>❗Unlicensed</code>
* <b>[pandera](https://github.com/pandera-dev/pandera) ⭐ 4,452 | 🐛 427 | 🌐 Python | 📅 2026-09-09</b> (🥈27 ·  ⭐ 4.4K) - A light-weight and flexible data validation and testing.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
* <b>[Koalas](https://github.com/databricks/koalas) ⭐ 3,374 | 🐛 108 | 🌐 Python | 📅 2024-03-20</b> (🥉24 ·  ⭐ 3.4K · 💀) - Koalas: pandas API on Apache Spark. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>spark</code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
* <b>[Arctic](https://github.com/man-group/arctic) ⭐ 3,086 | 🐛 97 | 🌐 Python | 📅 2024-04-08</b> (🥉21 ·  ⭐ 3.1K) - Arctic is a high performance datastore for numeric data. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code>
* <b>[sklearn-pandas](https://github.com/scikit-learn-contrib/sklearn-pandas) ⭐ 2,841 | 🐛 43 | 🌐 Python | 📅 2023-06-08</b> (🥉24 ·  ⭐ 2.8K · 💀) - Pandas integration with sklearn. <code><a href="https://tldrlegal.com/search?q=Zlib">❗️Zlib</a></code> <code>sklearn</code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
* <b>[swifter](https://github.com/jmcarpenter2/swifter) ⭐ 2,634 | 🐛 26 | 🌐 Python | 📅 2024-03-20</b> (🥉24 ·  ⭐ 2.5K · 💀) - A package which efficiently applies any function to a pandas.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
* <b>[Pandas Summary](https://github.com/mouradmourafiq/pandas-summary) ⭐ 534 | 🐛 7 | 🌐 Python | 📅 2026-09-04</b> (🥉17 ·  ⭐ 530 · 💀) - An extension to pandas describe function. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
* <b>[daffy](https://github.com/vertti/daffy) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-09-09</b> (🥉15 ·  ⭐ 58) - Lightweight DataFrame validation decorators for Pandas, Polars, Modin,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/tobgu/pyrsistent">pyrsistent</a></b> (🥇32 ·  ⭐ 2.2K) - Persistent/Immutable/Functional data structures for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

* [GitHub](https://github.com/tobgu/pyrsistent) ⭐ 2,200 | 🐛 39 | 🌐 Python | 📅 2026-01-31 (👨‍💻 78 · 🔀 160 · 📦 370K):

  ```
  git clone https://github.com/tobgu/pyrsistent
  ```
* [PyPi](https://pypi.org/project/pyrsistent) (📥 30M / month · 📦 1K · ⏱️ 25.10.2023):
  ```
  pip install pyrsistent
  ```
* [Conda](https://anaconda.org/conda-forge/pyrsistent) (📥 22M · ⏱️ 04.09.2026):
  ```
  conda install -c conda-forge pyrsistent
  ```

</details>
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥇30 ·  ⭐ 1.6K) - The bidirectional mapping library for Python. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

* [GitHub](https://github.com/jab/bidict) ⭐ 1,587 | 🐛 1 | 🌐 Python | 📅 2026-08-25 (👨‍💻 26 · 🔀 69 · 📦 46K):

  ```
  git clone https://github.com/jab/bidict
  ```
* [PyPi](https://pypi.org/project/bidict) (📥 28M / month · 📦 690 · ⏱️ 25.08.2026):
  ```
  pip install bidict
  ```
* [Conda](https://anaconda.org/conda-forge/bidict) (📥 950K · ⏱️ 26.08.2026):
  ```
...
* [GitHub](https://github.com/aio-libs/multidict) ⭐ 492 | 🐛 26 | 🌐 Python | 📅 2026-09-10 (👨‍💻 72 · 🔀 130):

  ```
  git clone https://github.com/aio-libs/multidict
  ```
* [PyPi](https://pypi.org/project/multidict) (📥 520M / month · 📦 2.3K · ⏱️ 09.09.2026):
  ```
  pip install multidict
  ```
* [Conda](https://anaconda.org/conda-forge/multidict) (📥 29M · ⏱️ 20.02.2026):
  ```
...
* [GitHub](https://github.com/mewwts/addict) ⭐ 2,545 | 🐛 27 | 🌐 Python | 📅 2026-03-24 (👨‍💻 34 · 🔀 130 · 📦 18K):

  ```
  git clone https://github.com/mewwts/addict
  ```
* [PyPi](https://pypi.org/project/addict) (📥 6.4M / month · 📦 450 · ⏱️ 21.11.2020):
  ```
  pip install addict
  ```
...
* [GitHub](https://github.com/mahmoud/glom) ⭐ 2,164 | 🐛 133 | 🌐 Python | 📅 2026-09-08 (👨‍💻 24 · 🔀 77 · 📦 3.7K):

  ```
  git clone https://github.com/mahmoud/glom
  ```
* [PyPi](https://pypi.org/project/glom) (📥 23M / month · 📦 250 · ⏱️ 29.12.2025):
  ```
  pip install glom
  ```
...
* [GitHub](https://github.com/c0fec0de/anytree) ⭐ 1,093 | 🐛 40 | 🌐 Python | 📅 2025-04-08 (👨‍💻 30 · 🔀 140 · 📦 24K):

  ```
  git clone https://github.com/c0fec0de/anytree
  ```
* [PyPi](https://pypi.org/project/anytree) (📥 5.7M / month · 📦 580 · ⏱️ 08.04.2025):
  ```
  pip install anytree
  ```
* [Conda](https://anaconda.org/conda-forge/anytree) (📥 110K · ⏱️ 25.04.2026):
  ```
...
* [GitHub](https://github.com/fabiocaccamo/python-benedict) ⭐ 1,608 | 🐛 7 | 🌐 Python | 📅 2026-09-02 (👨‍💻 18 · 🔀 49 · 📦 2K):

  ```
  git clone https://github.com/fabiocaccamo/python-benedict
  ```
* [PyPi](https://pypi.org/project/python-benedict) (📥 880K / month · 📦 110 · ⏱️ 07.07.2026):
  ```
...
* [GitHub](https://github.com/MagicStack/immutables) ⭐ 1,203 | 🐛 12 | 🌐 C | 📅 2025-05-20 (👨‍💻 17 · 🔀 59 · 📦 8K):

  ```
  git clone https://github.com/MagicStack/immutables
  ```
* [PyPi](https://pypi.org/project/immutables) (📥 2M / month · 📦 140 · ⏱️ 10.10.2024):
  ```
  pip install immutables
  ```
* [Conda](https://anaconda.org/conda-forge/immutables) (📥 2M · ⏱️ 05.09.2026):
  ```
...
* [GitHub](https://github.com/cdgriffith/Box) ⭐ 2,830 | 🐛 49 | 🌐 Python | 📅 2026-02-21 (👨‍💻 1 · 🔀 120):

  ```
  git clone https://github.com/cdgriffith/Box
  ```
* [PyPi](https://pypi.org/project/python-box) (📥 5.6M / month · 📦 590 · ⏱️ 21.02.2026):
  ```
  pip install python-box
  ```
* [Conda](https://anaconda.org/conda-forge/python-box) (📥 1.3M · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/aio-libs/janus) ⭐ 967 | 🐛 12 | 🌐 Python | 📅 2026-08-03 (👨‍💻 30 · 🔀 54):

  ```
  git clone https://github.com/aio-libs/janus
  ```
* [PyPi](https://pypi.org/project/janus) (📥 4.8M / month · 📦 130 · ⏱️ 13.12.2024):
  ```
  pip install janus
  ```
* [Conda](https://anaconda.org/conda-forge/janus) (📥 160K · ⏱️ 22.04.2025):
  ```
...
* <b>[python-sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,982 | 🐛 39 | 🌐 Python | 📅 2024-03-08</b> (🥈28 ·  ⭐ 3.9K · 💀) - Python Sorted Container Types: Sorted List, Sorted.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
* <b>[munch](https://github.com/Infinidat/munch) ⭐ 787 | 🐛 15 | 🌐 Python | 📅 2024-06-05</b> (🥉22 ·  ⭐ 780 · 💀) - A Munch is a Python dictionary that provides attribute-style access (a.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[ordered-set](https://github.com/rspeer/ordered-set) ⭐ 231 | 🐛 17 | 🌐 Python | 📅 2024-08-09</b> (🥈27 ·  ⭐ 210 · 💀) - A mutable set that remembers the order of its entries. One of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub]() (👨‍💻 810 · 🔀 2.9K · 📦 1.1M):
  ...
  ```
* [PyPi](https://pypi.org/project/pydantic) (📥 980M / month · 📦 100K · ⏱️ 09.09.2026):
  ```
  pip install pydantic
  ```
* [Conda](https://anaconda.org/conda-forge/pydantic) (📥 30M · ⏱️ 28.08.2026):
  ```
...
* [GitHub]() (👨‍💻 120 · 🔀 630 · 📦 860K):
  ...
  ```
* [PyPi](https://pypi.org/project/jsonschema) (📥 530M / month · 📦 9.6K · ⏱️ 07.01.2026):
  ```
  pip install jsonschema
  ```
* [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 52M · ⏱️ 24.08.2026):
  ```
...
* [GitHub](https://github.com/pyeve/cerberus) ⭐ 3,283 | 🐛 23 | 🌐 Python | 📅 2026-07-01 (👨‍💻 67 · 🔀 240 · 📦 18K):

  ```
  git clone https://github.com/pyeve/cerberus
  ```
* [PyPi](https://pypi.org/project/cerberus) (📥 5.5M / month · 📦 770 · ⏱️ 06.11.2025):
  ```
...
* [GitHub](https://github.com/keleshev/schema) ⭐ 2,946 | 🐛 110 | 🌐 Python | 📅 2026-06-20 (👨‍💻 75 · 🔀 220 · 📦 17K):

  ```
  git clone https://github.com/keleshev/schema
  ```
* [PyPi](https://pypi.org/project/schema) (📥 24M / month · 📦 890 · ⏱️ 11.10.2025):
  ```
  pip install schema
  ```
* [Conda](https://anaconda.org/conda-forge/schema) (📥 720K · ⏱️ 20.07.2026):
  ```
...
* [GitHub](https://github.com/alecthomas/voluptuous) ⭐ 1,850 | 🐛 46 | 🌐 Python | 📅 2026-07-25 (👨‍💻 110 · 🔀 220 · 📦 22K):

  ```
  git clone https://github.com/alecthomas/voluptuous
  ```
* [PyPi](https://pypi.org/project/voluptuous) (📥 6.5M / month · 📦 620 · ⏱️ 18.12.2025):
  ```
  pip install voluptuous
  ```
* [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 1M · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/holoviz/param) ⭐ 521 | 🐛 179 | 🌐 Python | 📅 2026-09-08 (👨‍💻 52 · 🔀 86 · 📦 18K):

  ```
  git clone https://github.com/holoviz/param
  ```
* [PyPi](https://pypi.org/project/param) (📥 1.9M / month · 📦 260 · ⏱️ 09.09.2026):
  ```
  pip install param
  ```
* [Conda](https://anaconda.org/conda-forge/param) (📥 3.1M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,004 | 🐛 29 | 🌐 Python | 📅 2026-08-10 (👨‍💻 21 · 🔀 48 · 📦 1.1K):

  ```
  git clone https://github.com/samuelcolvin/dirty-equals
  ```
* [PyPi](https://pypi.org/project/dirty-equals) (📥 2.6M / month · 📦 100 · ⏱️ 17.11.2025):
  ```
...
* <b>[schematics](https://github.com/schematics/schematics) ⭐ 2,586 | 🐛 109 | 🌐 Python | 📅 2023-07-12</b> (🥉25 ·  ⭐ 2.6K · 💀) - Python Data Structures for Humans. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
* <b>[strictyaml](https://github.com/crdoconnor/strictyaml) ⭐ 1,626 | 🐛 105 | 🌐 Python | 📅 2025-05-23</b> (🥉26 ·  ⭐ 1.6K · 💀) - Type-safe YAML parser and validator. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[python-email-validator](https://github.com/JoshData/python-email-validator) ⭐ 1,445 | 🐛 15 | 🌐 Python | 📅 2026-06-26</b> (🥉27 ·  ⭐ 1.3K · 💀) - A robust email syntax and deliverability validation.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code>
...
🔗 <b>[python-patterns](https://github.com/faif/python-patterns) ⭐ 42,974 | 🐛 15 | 🌐 Python | 📅 2026-09-10</b> ( ⭐ 43K)  - Collection of design patterns/idioms in Python.
...
* [GitHub](https://github.com/keon/algorithms) ⭐ 25,547 | 🐛 4 | 🌐 Python | 📅 2026-08-30 (👨‍💻 220 · 🔀 4.7K · 📦 140):
...
* [PyPi](https://pypi.org/project/algorithms) (📥 2.4K / month · 📦 5 · ⏱️ 18.02.2026):
  ...
  ```
* [Conda](https://anaconda.org/conda-forge/algorithms) (📥 5.2K · ⏱️ 22.04.2025):
  ```
...
* <b>[transitions](https://github.com/pytransitions/transitions) ⭐ 6,586 | 🐛 22 | 🌐 Python | 📅 2025-09-11</b> (🥇24 ·  ⭐ 6.1K · 💀) - A lightweight, object-oriented finite state machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[PyPattyrn](https://github.com/tylerlaberge/PyPattyrn) ⚠️ Archived</b> (🥉19 ·  ⭐ 2.3K · 💀) - A simple library for implementing common design patterns. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub](https://github.com/arrow-py/arrow) ⭐ 9,053 | 🐛 195 | 🌐 Python | 📅 2026-06-22 (👨‍💻 290 · 🔀 730 · 📦 190K):

  ```
  git clone https://github.com/arrow-py/arrow
  ```
* [PyPi](https://pypi.org/project/arrow) (📥 68M / month · 📦 2.3K · ⏱️ 18.10.2025):
  ```
  pip install arrow
  ```
...
* [GitHub](https://github.com/scrapinghub/dateparser) ⭐ 2,854 | 🐛 346 | 🌐 Python | 📅 2026-09-09 (👨‍💻 160 · 🔀 510 · 📦 40K):

  ```
  git clone https://github.com/scrapinghub/dateparser
  ```
* [PyPi](https://pypi.org/project/dateparser) (📥 41M / month · 📦 1.7K · ⏱️ 03.09.2026):
  ```
  pip install dateparser
  ```
* [Conda](https://anaconda.org/conda-forge/dateparser) (📥 2.2M · ⏱️ 03.09.2026):
  ```
...
* [GitHub](https://github.com/stub42/pytz) ⭐ 396 | 🐛 39 | 🌐 C | 📅 2026-07-25 (👨‍💻 27 · 🔀 110 · 📦 2.5M):

  ```
  git clone https://github.com/stub42/pytz
  ```
* [PyPi](https://pypi.org/project/pytz) (📥 450M / month · 📦 16K · ⏱️ 25.07.2026):
  ```
  pip install pytz
  ```
* [Conda](https://anaconda.org/conda-forge/pytz) (📥 98M · ⏱️ 26.07.2026):
  ```
...
* [GitHub](https://github.com/vacanza/holidays) ⭐ 1,930 | 🐛 79 | 🌐 Python | 📅 2026-09-10 (👨‍💻 350 · 🔀 710 · 📦 28K):

  ```
  git clone https://github.com/vacanza/holidays
  ```
* [PyPi](https://pypi.org/project/holidays) (📥 29M / month · 📦 660 · ⏱️ 09.09.2026):
  ```
  pip install holidays
  ```
* [Conda](https://anaconda.org/conda-forge/holidays) (📥 4.7M · ⏱️ 08.09.2026):
  ```
  conda install -c conda-forge holidays
  ```

</details>
<details><summary><b><a href="https://github.com/regebro/tzlocal">tzlocal</a></b> (🥉30 ·  ⭐ 220) - A Python module that tries to figure out what your local timezone is. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
* [GitHub](https://github.com/regebro/tzlocal) ⭐ 220 | 🐛 3 | 🌐 Python | 📅 2026-06-29 (👨‍💻 31 · 🔀 64 · 📦 230K):
  ...
  ```
* [PyPi](https://pypi.org/project/tzlocal) (📥 190M / month · 📦 2.4K · ⏱️ 29.06.2026):
  ```
  pip install tzlocal
  ```
* [Conda](https://anaconda.org/conda-forge/tzlocal) (📥 7.3M · ⏱️ 29.06.2026):
  ```
...
* [GitHub](https://github.com/dateutil/dateutil) ⭐ 2,633 | 🐛 489 | 🌐 Python | 📅 2026-05-19 (👨‍💻 130 · 🔀 540):

  ```
  git clone https://github.com/dateutil/dateutil
  ```
* [PyPi](https://pypi.org/project/python-dateutil) (📥 1B / month · 📦 12K · ⏱️ 01.03.2024):
  ```
...
* [GitHub]() (👨‍💻 130 · 🔀 420 · 📦 41K):
  ...
  ```
* [PyPi](https://pypi.org/project/pendulum) (📥 61M / month · 📦 1.6K · ⏱️ 30.01.2026):
  ```
...
* [GitHub](https://github.com/fsspec/filesystem_spec) ⭐ 1,351 | 🐛 359 | 🌐 Python | 📅 2026-09-09 (👨‍💻 350 · 🔀 470 · 📦 310K):

  ```
  git clone https://github.com/fsspec/filesystem_spec
  ```
* [PyPi](https://pypi.org/project/fsspec) (📥 710M / month · 📦 3.9K · ⏱️ 28.07.2026):
  ```
  pip install fsspec
  ```
* [Conda](https://anaconda.org/conda-forge/fsspec) (📥 39M · ⏱️ 29.07.2026):
  ```
...
* [GitHub](https://github.com/gorakhargosh/watchdog) ⭐ 7,408 | 🐛 255 | 🌐 Python | 📅 2026-09-06 (👨‍💻 180 · 🔀 720 · 📦 270K):

  ```
  git clone https://github.com/gorakhargosh/watchdog
  ```
* [PyPi](https://pypi.org/project/watchdog) (📥 99M / month · 📦 2.7K · ⏱️ 01.11.2024):
  ```
  pip install watchdog
  ```
* [Conda](https://anaconda.org/conda-forge/watchdog) (📥 6.4M · ⏱️ 04.09.2026):
  ```
...
* [GitHub]() (👨‍💻 70 · 🔀 140 · 📦 740K):
  ...
  ```
* [PyPi](https://pypi.org/project/filelock) (📥 590M / month · 📦 5.8K · ⏱️ 08.09.2026):
  ```
  pip install filelock
  ```
* [Conda](https://anaconda.org/conda-forge/filelock) (📥 50M · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/Tinche/aiofiles) ⭐ 3,259 | 🐛 58 | 🌐 Python | 📅 2026-08-29 (👨‍💻 45 · 🔀 170 · 📦 250K):

  ```
  git clone https://github.com/Tinche/aiofiles
  ```
* [PyPi](https://pypi.org/project/aiofiles) (📥 140M / month · 📦 7.7K · ⏱️ 09.10.2025):
  ```
...
* <b>[path](https://github.com/jaraco/path) ⭐ 1,125 | 🐛 10 | 🌐 Python | 📅 2026-04-13</b> (🥉24 ·  ⭐ 1.1K · 💀) - Object-oriented file system path manipulation. <code>❗Unlicensed</code>
...
* [GitHub](https://github.com/python/typing) ⭐ 1,783 | 🐛 229 | 🌐 Python | 📅 2026-09-04 (👨‍💻 150 · 🔀 290):
...
* <b>[six](https://github.com/benjaminp/six) ⭐ 1,029 | 🐛 114 | 🌐 Python | 📅 2026-02-23</b> (🥇32 ·  ⭐ 990 · 💀) - Python 2 and 3 compatibility library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b>[pathlib2](https://github.com/jazzband/pathlib2) ⭐ 86 | 🐛 7 | 🌐 Python | 📅 2023-09-29</b> (🥉25 ·  ⭐ 86) - Backport of pathlib aiming to support the full stdlib Python API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/pyca/bcrypt">bcrypt</a></b> (🥈33 ·  ⭐ 1.4K) - Modern(-ish) password hashing for your software and your servers. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

* [GitHub](https://github.com/pyca/bcrypt) ⭐ 1,503 | 🐛 9 | 🌐 Python | 📅 2026-08-31 (👨‍💻 41 · 🔀 180 · 📦 360K):

  ```
  git clone https://github.com/pyca/bcrypt
  ```
* [PyPi](https://pypi.org/project/bcrypt) (📥 180M / month · 📦 2K · ⏱️ 25.09.2025):
  ```
  pip install bcrypt
  ```
...
* [GitHub](https://github.com/Legrandin/pycryptodome) ⭐ 3,262 | 🐛 95 | 🌐 C | 📅 2026-07-18 (👨‍💻 170 · 🔀 560 · 📦 150K):

  ```
  git clone https://github.com/Legrandin/pycryptodome
  ```
* [PyPi](https://pypi.org/project/pycryptodomex) (📥 54M / month · 📦 1.6K · ⏱️ 17.05.2025):
  ```
  pip install pycryptodomex
  ```
* [Conda](https://anaconda.org/conda-forge/pycryptodomex) (📥 3.1M · ⏱️ 13.09.2025):
  ```
...
* <b>[cryptography](https://github.com/pyca/cryptography) ⭐ 7,762 | 🐛 35 | 🌐 Python | 📅 2026-09-10</b> (🥇34 ·  ⭐ 7.8K) - cryptography is a package designed to expose.. <code>❗Unlicensed</code>
* <b>[keyring](https://github.com/jaraco/keyring) ⭐ 1,512 | 🐛 108 | 🌐 Python | 📅 2026-04-13</b> (🥉29 ·  ⭐ 1.4K · 💤) - Store and access your passwords safely. <code>❗Unlicensed</code>
...
* [GitHub](https://github.com/boto/botocore) ⭐ 1,644 | 🐛 196 | 🌐 Python | 📅 2026-09-10 (👨‍💻 220 · 🔀 1.2K · 📦 440K):

  ```
  git clone https://github.com/boto/botocore
  ```
* [PyPi](https://pypi.org/project/botocore) (📥 990M / month · 📦 4.9K · ⏱️ 09.09.2026):
  ```
  pip install botocore
  ```
* [Conda](https://anaconda.org/conda-forge/botocore) (📥 50M · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/ansible/ansible) ⭐ 70,628 | 🐛 834 | 🌐 Python | 📅 2026-09-09 (👨‍💻 7K · 🔀 24K · 📦 43K):

  ```
  git clone https://github.com/ansible/ansible
  ```
* [PyPi](https://pypi.org/project/ansible) (📥 10M / month · 📦 600 · ⏱️ 08.09.2026):
  ```
  pip install ansible
  ```
* [Conda](https://anaconda.org/conda-forge/ansible) (📥 2M · ⏱️ 08.09.2026):
  ```
...
* [GitHub](https://github.com/docker/docker-py) ⭐ 7,211 | 🐛 569 | 🌐 Python | 📅 2026-09-07 (👨‍💻 460 · 🔀 1.7K · 📦 130K):

  ```
  git clone https://github.com/docker/docker-py
  ```
* [PyPi](https://pypi.org/project/docker) (📥 160M / month · 📦 5.8K · ⏱️ 09.07.2026):
  ```
  pip install docker
  ```
* [Conda](https://anaconda.org/conda-forge/docker-py) (📥 8.2M · ⏱️ 12.07.2026):
  ```
...
* [GitHub](https://github.com/pulumi/pulumi) ⭐ 25,662 | 🐛 2,415 | 🌐 Go | 📅 2026-09-10 (👨‍💻 4.2K · 🔀 1.4K · 📦 11K):

  ```
  git clone https://github.com/pulumi/pulumi
  ```
* [PyPi](https://pypi.org/project/pulumi) (📥 6.9M / month · 📦 590 · ⏱️ 10.09.2026):
  ```
  pip install pulumi
  ```
* [npm](https://www.npmjs.com/package/@pulumi/pulumi) (📥 12M / month · 📦 930 · ⏱️ 10.09.2026):
  ```
...
* [GitHub](https://github.com/paramiko/paramiko) ⭐ 9,848 | 🐛 1,192 | 🌐 Python | 📅 2026-08-29 (👨‍💻 190 · 🔀 2.1K · 📦 130K):

  ```
  git clone https://github.com/paramiko/paramiko
  ```
* [PyPi](https://pypi.org/project/paramiko) (📥 130M / month · 📦 4.6K · ⏱️ 09.05.2026):
  ```
  pip install paramiko
  ```
* [Conda](https://anaconda.org/conda-forge/paramiko) (📥 9.9M · ⏱️ 19.05.2026):
  ```
...
* [GitHub](https://github.com/aws/aws-cli) ⭐ 17,244 | 🐛 735 | 🌐 Python | 📅 2026-09-10 (👨‍💻 510 · 🔀 4.6K · 📦 5):

  ```
  git clone https://github.com/aws/aws-cli
  ```
* [PyPi](https://pypi.org/project/awscli) (📥 120M / month · 📦 780 · ⏱️ 27.08.2026):
  ```
  pip install awscli
  ```
* [Conda](https://anaconda.org/conda-forge/awscli) (📥 62M · ⏱️ 08.09.2026):
  ```
...
* [GitHub](https://github.com/kubernetes-client/python) ⭐ 7,660 | 🐛 71 | 🌐 Python | 📅 2026-09-08 (👨‍💻 260 · 🔀 3.5K):

  ```
  git clone https://github.com/kubernetes-client/python
  ```
* [PyPi](https://pypi.org/project/kubernetes) (📥 89M / month · 📦 2.6K · ⏱️ 02.09.2026):
  ```
...
* [GitHub](https://github.com/ktbyers/netmiko) ⭐ 4,279 | 🐛 62 | 🌐 Python | 📅 2026-08-18 (👨‍💻 280 · 🔀 1.4K · 📦 5.7K):

  ```
  git clone https://github.com/ktbyers/netmiko
  ```
* [PyPi](https://pypi.org/project/netmiko) (📥 1M / month · 📦 270 · ⏱️ 12.05.2026):
  ```
  pip install netmiko
  ```
...
* [GitHub](https://github.com/tomerfiliba/plumbum) ⭐ 3,051 | 🐛 140 | 🌐 Python | 📅 2026-09-02 (👨‍💻 130 · 🔀 200 · 📦 9.7K):

  ```
  git clone https://github.com/tomerfiliba/plumbum
  ```
* [PyPi](https://pypi.org/project/plumbum) (📥 5.1M / month · 📦 390 · ⏱️ 22.07.2026):
  ```
  pip install plumbum
  ```
...
* [GitHub](https://github.com/docker/compose) ⭐ 38,134 | 🐛 107 | 🌐 Go | 📅 2026-09-10 (👨‍💻 660 · 🔀 5.8K · 📦 260):

  ```
  git clone https://github.com/docker/compose
  ```
* [PyPi](https://pypi.org/project/docker-compose) (📥 920K / month · 📦 250 · ⏱️ 10.05.2021):
  ```
  pip install docker-compose
  ```
* [Conda](https://anaconda.org/conda-forge/docker-compose) (📥 920K · ⏱️ 03.09.2026):
  ```
...
* [GitHub](https://github.com/fabric/fabric) ⭐ 15,497 | 🐛 508 | 🌐 Python | 📅 2026-04-10 (👨‍💻 140 · 🔀 2K · 📦 24):

  ```
  git clone https://github.com/fabric/fabric
  ```
* [PyPi](https://pypi.org/project/fabric) (📥 9.6M / month · 📦 450 · ⏱️ 06.04.2026):
  ```
  pip install fabric
  ```
* [Conda](https://anaconda.org/conda-forge/fabric) (📥 670K · ⏱️ 06.04.2026):
  ```
...
* [GitHub]() (👨‍💻 220 · 🔀 530 · 📦 250):
  ...
  ```
* [PyPi](https://pypi.org/project/pyinfra) (📥 210K / month · 📦 46 · ⏱️ 27.07.2026):
  ```
  pip install pyinfra
  ```
...
* [GitHub](https://github.com/emre/storm) ⚠️ Archived (👨‍💻 30 · 🔀 150):
  ...
  ```
* [PyPi](https://pypi.org/project/storm) (📥 3.4K / month · 📦 4 · ⏱️ 02.07.2026):
  ```
  pip install storm
  ```
...
* <b>[schedule](https://github.com/dbader/schedule) ⭐ 12,264 | 🐛 179 | 🌐 Python | 📅 2024-05-25</b> (🥈29 ·  ⭐ 12K · 💀) - Python job scheduling for humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[wssh](https://github.com/aluzzardi/wssh) ⭐ 1,372 | 🐛 26 | 🌐 JavaScript | 📅 2019-02-12</b> (🥉15 ·  ⭐ 1.3K · 💀) - SSH to WebSockets Bridge. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[sshtunnel](https://github.com/pahaz/sshtunnel) ⭐ 1,297 | 🐛 81 | 🌐 Python | 📅 2025-08-27</b> (🥉27 ·  ⭐ 1.2K · 💀) - SSH tunnels to remote server. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub](https://github.com/amoffat/sh) ⭐ 7,240 | 🐛 2 | 🌐 Python | 📅 2026-07-25 (👨‍💻 110 · 🔀 510 · 📦 19K):

  ```
  git clone https://github.com/amoffat/sh
  ```
* [PyPi](https://pypi.org/project/sh) (📥 9.5M / month · 📦 860 · ⏱️ 25.07.2026):
  ```
  pip install sh
  ```
* [Conda](https://anaconda.org/conda-forge/sh) (📥 520K · ⏱️ 06.06.2026):
  ```
...
* [GitHub](https://github.com/Supervisor/supervisor) ⭐ 9,110 | 🐛 182 | 🌐 Python | 📅 2025-12-21 (👨‍💻 180 · 🔀 1.3K · 📦 14K):
...
* [PyPi](https://pypi.org/project/supervisor) (📥 16M / month · 📦 160 · ⏱️ 23.08.2025):
  ...
  ```
* [Conda](https://anaconda.org/conda-forge/supervisor) (📥 810K · ⏱️ 27.02.2026):
  ```
...
* <b>[pexpect](https://github.com/pexpect/pexpect) ⭐ 2,848 | 🐛 171 | 🌐 Python | 📅 2025-04-11</b> (🥇31 ·  ⭐ 2.7K · 💀) - A Python module for controlling interactive programs in a pseudo-.. <code><a href="http://bit.ly/3hkKRql">ISC</a></code>
...
* [GitHub](https://github.com/agronholm/anyio) ⭐ 2,539 | 🐛 110 | 🌐 Python | 📅 2026-09-07 (👨‍💻 99 · 🔀 180 · 📦 670K):

  ```
  git clone https://github.com/agronholm/anyio
  ```
* [PyPi](https://pypi.org/project/anyio) (📥 920M / month · 📦 8.1K · ⏱️ 05.09.2026):
  ```
  pip install anyio
  ```
* [Conda](https://anaconda.org/conda-forge/anyio) (📥 42M · ⏱️ 07.09.2026):
  ```
...
* [GitHub](https://github.com/MagicStack/uvloop) ⭐ 11,898 | 🐛 159 | 🌐 Cython | 📅 2026-07-14 (👨‍💻 79 · 🔀 610 · 📦 230K):

  ```
  git clone https://github.com/MagicStack/uvloop
  ```
* [PyPi](https://pypi.org/project/uvloop) (📥 240M / month · 📦 2K · ⏱️ 16.10.2025):
  ```
  pip install uvloop
  ```
* [Conda](https://anaconda.org/conda-forge/uvloop) (📥 4.9M · ⏱️ 07.11.2025):
  ```
...
* [PyPi](https://pypi.org/project/asyncer) (📥 6.8M / month · 📦 320 · ⏱️ 25.06.2026):
  ...
  pip install asyncer
  ```
* [Conda](https://anaconda.org/conda-forge/asyncer) (📥 51K · ⏱️ 25.06.2026):
  ```
...
* [GitHub](https://github.com/aiokitchen/aiomisc) ⭐ 425 | 🐛 10 | 🌐 Python | 📅 2026-09-10 (👨‍💻 22 · 🔀 28 · 📦 450):

  ```
  git clone https://github.com/aiokitchen/aiomisc
  ```
* [PyPi](https://pypi.org/project/aiomisc) (📥 56K / month · 📦 61 · ⏱️ 06.09.2026):
  ```
  pip install aiomisc
  ```
...
* <b>[greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,847 | 🐛 24 | 🌐 C++ | 📅 2026-09-01</b> (🥈32 ·  ⭐ 1.8K) - Lightweight in-process concurrent programming. <code>❗Unlicensed</code>
* <b>[unsync](https://github.com/alex-sherman/unsync) ⭐ 900 | 🐛 3 | 🌐 Python | 📅 2025-01-09</b> (🥉20 ·  ⭐ 900 · 💀) - Unsynchronize asyncio. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[stopit](https://github.com/glenfant/stopit) ⭐ 127 | 🐛 17 | 🌐 Python | 📅 2024-01-09</b> (🥉19 ·  ⭐ 35 · 💤) - Raise asynchronous exceptions in other thread, control the timeout.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
* [GitHub](https://github.com/theskumar/python-dotenv) ⭐ 8,873 | 🐛 113 | 🌐 Python | 📅 2026-08-23 (👨‍💻 120 · 🔀 560 · 📦 1.7M):

  ```
  git clone https://github.com/theskumar/python-dotenv
  ```
* [PyPi](https://pypi.org/project/python-dotenv) (📥 700M / month · 📦 45K · ⏱️ 16.08.2026):
  ```
...
* [GitHub](https://github.com/ipython/traitlets) ⭐ 653 | 🐛 111 | 🌐 Python | 📅 2026-09-03 (👨‍💻 130 · 🔀 210 · 📦 620K):
  ...
  ```
* [PyPi](https://pypi.org/project/traitlets) (📥 130M / month · 📦 2.3K · ⏱️ 03.08.2026):
  ```
  pip install traitlets
  ```
* [Conda](https://anaconda.org/conda-forge/traitlets) (📥 57M · ⏱️ 03.08.2026):
  ```
...
* [GitHub](https://github.com/omry/omegaconf) ⭐ 2,431 | 🐛 34 | 🌐 Python | 📅 2026-09-10 (👨‍💻 48 · 🔀 160 · 📦 65K):

  ```
  git clone https://github.com/omry/omegaconf
  ```
* [PyPi](https://pypi.org/project/omegaconf) (📥 35M / month · 📦 2.6K · ⏱️ 07.08.2026):
  ```
...
* [GitHub]() (👨‍💻 130 · 🔀 340):
  ...
  ```
* [PyPi](https://pypi.org/project/dynaconf) (📥 5.6M / month · 📦 780 · ⏱️ 05.08.2026):
  ```
  pip install dynaconf
  ```
* [Conda](https://anaconda.org/conda-forge/dynaconf) (📥 240K · ⏱️ 06.08.2026):
  ```
...
* [GitHub](https://github.com/DiffSK/configobj) ⭐ 337 | 🐛 73 | 🌐 Python | 📅 2026-08-19 (👨‍💻 13 · 🔀 88 · 📦 50K):

  ```
  git clone https://github.com/DiffSK/configobj
  ```
* [PyPi](https://pypi.org/project/configobj) (📥 6.2M / month · 📦 650 · ⏱️ 21.09.2024):
  ```
...
<details><summary><b><a href="https://github.com/willkg/everett">everett</a></b> (🥉19 ·  ⭐ 150 · 💤) - configuration library for python projects. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>
...
* [GitHub](https://github.com/willkg/everett) ⚠️ Archived (👨‍💻 9 · 🔀 14 · 📋 96 - 4% open · ⏱️ 15.10.2025):
  ...
  ```
* [PyPi](https://pypi.org/project/everett) (📥 500K / month · 📦 22 · ⏱️ 15.10.2025):
  ```
  pip install everett
  ```
* [Conda](https://anaconda.org/conda-forge/everett) (📥 130K · ⏱️ 22.04.2025):
  ```
...
* <b>[python-decouple](http://github.com/henriquebastos/python-decouple/) ⭐ 3,037 | 🐛 23 | 🌐 Python | 📅 2024-11-28</b> (🥈27 ·  ⭐ 3K · 💀) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[gin-config](https://github.com/google/gin-config) ⭐ 2,156 | 🐛 60 | 🌐 Python | 📅 2026-09-09</b> (🥉24 ·  ⭐ 2.1K · 💀) - Gin provides a lightweight configuration framework for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
* <b>[hydra](http://github.com/crankycoder/Hydra) ⭐ 22 | 🐛 7 | 🌐 Python | 📅 2023-12-24</b> (🥉19 ·  ⭐ 20) - A high performance persistent bloom filter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub](https://github.com/pallets/click) ⭐ 17,664 | 🐛 85 | 🌐 Python | 📅 2026-09-08 (👨‍💻 450 · 🔀 2K · 📦 2.4M):

  ```
  git clone https://github.com/pallets/click
  ```
* [PyPi](https://pypi.org/project/click) (📥 950M / month · 📦 75K · ⏱️ 26.08.2026):
  ```
  pip install click
  ```
* [Conda](https://anaconda.org/conda-forge/click) (📥 73M · ⏱️ 07.09.2026):
  ```
...
* [GitHub](https://github.com/Textualize/rich) ⭐ 57,347 | 🐛 374 | 🌐 Python | 📅 2026-06-23 (👨‍💻 290 · 🔀 2.2K · 📦 570K):
...
* [GitHub]() (👨‍💻 110 · 🔀 970 · 📦 280K):
  ...
  ```
* [PyPi](https://pypi.org/project/typer) (📥 290M / month · 📦 35K · ⏱️ 28.08.2026):
  ```
  pip install typer
  ```
* [Conda](https://anaconda.org/conda-forge/typer) (📥 15M · ⏱️ 28.08.2026):
  ```
...
* [GitHub](https://github.com/kislyuk/argcomplete) ⭐ 1,580 | 🐛 72 | 🌐 Python | 📅 2026-08-17 (👨‍💻 88 · 🔀 150 · 📦 76K):

  ```
  git clone https://github.com/kislyuk/argcomplete
  ```
* [PyPi](https://pypi.org/project/argcomplete) (📥 68M / month · 📦 2.4K · ⏱️ 06.08.2026):
  ```
  pip install argcomplete
  ```
* [Conda](https://anaconda.org/conda-forge/argcomplete) (📥 4M · ⏱️ 08.08.2026):
  ```
...
* [GitHub](https://github.com/google/python-fire) ⭐ 28,218 | 🐛 196 | 🌐 Python | 📅 2026-07-01 (👨‍💻 67 · 🔀 1.5K · 📦 54K):

  ```
  git clone https://github.com/google/python-fire
  ```
* [PyPi](https://pypi.org/project/fire) (📥 19M / month · 📦 3K · ⏱️ 16.08.2025):
  ```
  pip install fire
  ```
...
* [GitHub](https://github.com/bw2/ConfigArgParse) ⭐ 757 | 🐛 0 | 🌐 Python | 📅 2026-09-06 (👨‍💻 58 · 🔀 120 · 📦 26K):

  ```
  git clone https://github.com/bw2/ConfigArgParse
  ```
* [PyPi](https://pypi.org/project/configargparse) (📥 19M / month · 📦 820 · ⏱️ 06.09.2026):
  ```
  pip install configargparse
  ```
* [Conda](https://anaconda.org/conda-forge/configargparse) (📥 2.2M · ⏱️ 07.09.2026):
  ```
...
* [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) ⭐ 10,565 | 🐛 713 | 🌐 Python | 📅 2026-07-26 (👨‍💻 250 · 🔀 800):

  ```
  git clone https://github.com/prompt-toolkit/python-prompt-toolkit
  ```
* [PyPi](https://pypi.org/project/prompt_toolkit) (📥 210M / month · ⏱️ 26.07.2026):
  ```
  pip install prompt_toolkit
  ```
* [Conda](https://anaconda.org/conda-forge/prompt-toolkit) (📥 48M · ⏱️ 27.07.2026):
  ```
...
* [GitHub](https://github.com/tmbo/questionary) ⭐ 2,174 | 🐛 67 | 🌐 Python | 📅 2026-08-18 (👨‍💻 57 · 🔀 99 · 📦 25K):

  ```
  git clone https://github.com/tmbo/questionary
  ```
* [PyPi](https://pypi.org/project/questionary) (📥 23M / month · 📦 1.4K · ⏱️ 28.08.2025):
  ```
  pip install questionary
  ```
* [Conda](https://anaconda.org/conda-forge/questionary) (📥 520K · ⏱️ 08.09.2025):
  ```
...
* [GitHub](https://github.com/erikrose/blessings) ⭐ 1,487 | 🐛 32 | 🌐 Python | 📅 2025-08-28 (👨‍💻 17 · 🔀 150 · 📦 11K):

  ```
  git clone https://github.com/erikrose/blessings
  ```
* [PyPi](https://pypi.org/project/blessings) (📥 840K / month · 📦 460 · ⏱️ 21.06.2018):
  ```
...
* [GitHub](https://github.com/jazzband/docopt-ng) ⭐ 224 | 🐛 14 | 🌐 Python | 📅 2026-07-19 (👨‍💻 54 · 🔀 27 · 📦 870):
...
* [GitHub](https://github.com/kdeldycke/click-extra) ⭐ 121 | 🐛 5 | 🌐 Python | 📅 2026-09-10 (👨‍💻 15 · 🔀 11 · 📦 140):

  ```
  git clone https://github.com/kdeldycke/click-extra
  ```
* [PyPi](https://pypi.org/project/click-extra) (📥 71K / month · 📦 51 · ⏱️ 03.09.2026):
  ```
...
* <b>[docopt](https://github.com/docopt/docopt) ⭐ 8,008 | 🐛 267 | 🌐 Python | 📅 2025-06-23</b> (🥈29 ·  ⭐ 8K · 💀) - Create *beautiful* command-line interfaces with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b>[colorama](https://github.com/tartley/colorama) ⭐ 3,796 | 🐛 141 | 🌐 Python | 📅 2026-05-13</b> (🥈32 ·  ⭐ 3.7K · 💀) - Simple cross-platform colored terminal text in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
* <b>[bashplotlib](https://github.com/glamp/bashplotlib) ⭐ 1,919 | 🐛 24 | 🌐 Python | 📅 2024-06-23</b> (🥉19 ·  ⭐ 1.9K · 💀) - plotting in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[cleo](https://github.com/python-poetry/cleo) ⭐ 1,353 | 🐛 59 | 🌐 Python | 📅 2026-09-07</b> (🥉27 ·  ⭐ 1.3K · 💀) - Cleo allows you to create beautiful and testable command-line interfaces. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[colout](https://github.com/nojhan/colout) ⭐ 1,162 | 🐛 14 | 🌐 Python | 📅 2026-06-14</b> (🥉16 ·  ⭐ 1.2K · 💀) - Color text streams with a polished command line interface. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
* <b>[wcwidth](https://github.com/jquast/wcwidth) ⭐ 465 | 🐛 4 | 🌐 Python | 📅 2026-08-31</b> (🥈30 ·  ⭐ 470) - Python library that measures the width of strings in a terminal. <code>❗Unlicensed</code>
...
* <b>[onecite](https://github.com/HzaCode/OneCite) ⭐ 66 | 🐛 1 | 🌐 Python | 📅 2026-08-06</b> (🥉11 ·  ⭐ 56) - An intelligent toolkit to automatically parse, complete, and format.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
🔗 <b>[best-of-python-dev](https://github.com/ml-tooling/best-of-python-dev) ⭐ 1,300 | 🐛 31 | 🌐 Python | 📅 2026-09-10</b> ( ⭐ 1.2K · 💤)  - A ranked list of awesome python developer tools and libraries...
...
* [GitHub](https://github.com/tkem/cachetools) ⭐ 2,777 | 🐛 1 | 🌐 Python | 📅 2026-09-05 (👨‍💻 26 · 🔀 200 · 📦 700K):

  ```
  git clone https://github.com/tkem/cachetools
  ```
* [PyPi](https://pypi.org/project/cachetools) (📥 270M / month · 📦 5.3K · ⏱️ 31.08.2026):
  ```
  pip install cachetools
  ```
* [Conda](https://anaconda.org/conda-forge/cachetools) (📥 23M · ⏱️ 31.08.2026):
  ```
...
* [GitHub](https://github.com/aio-libs/aiocache) ⭐ 1,437 | 🐛 67 | 🌐 Python | 📅 2026-06-28 (👨‍💻 53 · 🔀 170 · 📦 5.1K):

  ```
  git clone https://github.com/aio-libs/aiocache
  ```
* [PyPi](https://pypi.org/project/aiocache) (📥 7.2M / month · 📦 150 · ⏱️ 25.09.2024):
  ```
...
* [GitHub](https://github.com/pydanny/cached-property) ⭐ 705 | 🐛 42 | 🌐 Python | 📅 2024-12-07 (👨‍💻 25 · 🔀 79 · 📦 58K):
  ...
  ```
* [PyPi](https://pypi.org/project/cached-property) (📥 24M / month · 📦 1.6K · ⏱️ 25.10.2024):
  ```
  pip install cached-property
  ```
* [Conda](https://anaconda.org/conda-forge/cached-property) (📥 28M · ⏱️ 25.08.2026):
  ```
  conda install -c conda-forge cached-property
  ```

</details>
<details><summary><b><a href="https://github.com/lericson/pylibmc">pylibmc</a></b> (🥉25 ·  ⭐ 480) - A Python wrapper around the libmemcached interface from TangentOrg. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

* [GitHub](https://github.com/lericson/pylibmc) ⭐ 492 | 🐛 40 | 🌐 C | 📅 2025-04-12 (👨‍💻 57 · 🔀 140 · 📦 5.9K):

  ```
  git clone https://github.com/lericson/pylibmc
  ```
* [PyPi](https://pypi.org/project/pylibmc) (📥 450K / month · 📦 79 · ⏱️ 30.08.2022):
  ```
  pip install pylibmc
  ```
* [Conda](https://anaconda.org/conda-forge/pylibmc) (📥 490K · ⏱️ 06.09.2026):
  ```
...
* <b>[cachier](https://github.com/python-cachier/cachier) ⭐ 663 | 🐛 20 | 🌐 Python | 📅 2026-09-01</b> (🥉17 ·  ⭐ 660) - Persistent, stale-free, local and cross-machine caching for.. <code>❗Unlicensed</code>
...
🔗 <b>[best-of-web-python - Web UI](https://github.com/ml-tooling/best-of-web-python) ⭐ 2,758 | 🐛 17 | 📅 2026-09-03</b> ( ⭐ 2.6K · 💤)  - Collection of libraries to implement web-based UIs.
...
* [GitHub](https://github.com/kivy/kivy) ⭐ 19,015 | 🐛 848 | 🌐 Python | 📅 2026-09-09 (👨‍💻 640 · 🔀 3.1K · 📦 18K):

  ```
  git clone https://github.com/kivy/kivy
  ```
* [PyPi](https://pypi.org/project/kivy) (📥 230K / month · 📦 360 · ⏱️ 26.12.2024):
  ```
  pip install kivy
  ```
* [Conda](https://anaconda.org/conda-forge/kivy) (📥 710K · ⏱️ 29.03.2026):
  ```
...
* [GitHub](https://github.com/hoffstadt/DearPyGui) ⭐ 15,609 | 🐛 329 | 🌐 C++ | 📅 2026-05-13 (👨‍💻 76 · 🔀 780 · 📦 4.5K):
...
* [GitHub](https://github.com/chriskiehl/Gooey) ⭐ 21,902 | 🐛 184 | 🌐 Python | 📅 2026-09-09 (👨‍💻 100 · 🔀 1K · 📦 1.1K):

  ```
  git clone https://github.com/chriskiehl/Gooey
  ```
* [PyPi](https://pypi.org/project/gooey) (📥 4.9K / month · 📦 100 · ⏱️ 29.01.2022):
  ```
  pip install gooey
  ```
...
* [GitHub](https://github.com/beeware/toga) ⭐ 5,411 | 🐛 313 | 🌐 Python | 📅 2026-09-09 (👨‍💻 350 · 🔀 820 · 📦 3):

  ```
  git clone https://github.com/beeware/toga
  ```
* [PyPi](https://pypi.org/project/toga) (📥 5.6K / month · 📦 50 · ⏱️ 08.07.2026):
  ```
  pip install toga
  ```
* [npm](https://www.npmjs.com/package/@pybee/toga) (📥 40 / month · 📦 5 · ⏱️ 23.04.2017):
  ```
...
* <b>[PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,813 | 🐛 708 | 🌐 Python | 📅 2026-08-30</b> (🥈24 ·  ⭐ 14K) - PySimpleGUI is a Python package that enables Python.. <code><a href="https://tldrlegal.com/search?q=PySimpleGUI%20License">❗️PySimpleGUI License</a></code>
...
* <b>[flexx](https://github.com/flexxui/flexx) ⭐ 3,329 | 🐛 97 | 🌐 Python | 📅 2025-01-20</b> (🥉20 ·  ⭐ 3.3K · 💀) - Write desktop and web apps in pure Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code>
* <b>[Phoenix](https://github.com/wxWidgets/Phoenix) ⭐ 2,625 | 🐛 623 | 🌐 Python | 📅 2026-09-09</b> (🥉20 ·  ⭐ 2.6K) - wxPythons Project Phoenix. A new implementation of wxPython,.. <code><a href="https://tldrlegal.com/search?q=wxWindows">❗️wxWindows</a></code>
* <b>[enaml](https://github.com/nucleic/enaml) ⭐ 1,576 | 🐛 62 | 🌐 Python | 📅 2026-08-03</b> (🥉19 ·  ⭐ 1.6K · 💤) - Declarative User Interfaces for Python. <code>❗Unlicensed</code>
...
🔗 <b>[best-of-ml-python - Computer Vision](https://github.com/ml-tooling/best-of-ml-python) ⭐ 23,797 | 🐛 57 | 📅 2026-09-10</b> ( ⭐ 16K · 💀)  - Collection of computer vision and image processing..

<details><summary>Show 1 hidden projects...</summary>

* <b>[Pipeless](https://github.com/pipeless-ai/pipeless) ⭐ 851 | 🐛 17 | 🌐 Rust | 📅 2024-05-08</b> (🥇12 ·  ⭐ 850 · 💀) - An open-source framework to create and deploy computer vision.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
🔗 <b>[best-of-ml-python](https://github.com/ml-tooling/best-of-ml-python) ⭐ 23,797 | 🐛 57 | 📅 2026-09-10</b> ( ⭐ 16K · 💀)  - A ranked list of awesome machine learning Python libraries. Updated..
...
🔗 <b>[best-of-ml-python - NLP](https://github.com/ml-tooling/best-of-ml-python#text-data--nlp) ⭐ 23,797 | 🐛 57 | 📅 2026-09-10</b> ( ⭐ 16K · 💀)  - Collection of text processing and NLP libraries.
...
* [GitHub](https://github.com/chardet/chardet) ⭐ 2,667 | 🐛 0 | 🌐 Python | 📅 2026-08-30 (👨‍💻 58 · 🔀 310 · 📦 970K):

  ```
  git clone https://github.com/chardet/chardet
  ```
* [PyPi](https://pypi.org/project/chardet) (📥 200M / month · 📦 7.4K · ⏱️ 14.08.2026):
  ```
  pip install chardet
  ```
* [Conda](https://anaconda.org/conda-forge/chardet) (📥 35M · ⏱️ 17.08.2026):
  ...
  ```
* [npm](https://www.npmjs.com/package/@pypi/chardet) (📥 79 / month · 📦 7 · ⏱️ 20.08.2017):
  ```
...
* [GitHub](https://github.com/un33k/python-slugify) ⭐ 1,624 | 🐛 0 | 🌐 Python | 📅 2026-09-09 (👨‍💻 40 · 🔀 130 · 📦 120K):

  ```
  git clone https://github.com/un33k/python-slugify
  ```
* [PyPi](https://pypi.org/project/python-slugify) (📥 73M / month · 📦 2.2K · ⏱️ 08.09.2026):
  ```
  pip install python-slugify
  ```
* [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 4.1M · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,772 | 🐛 12 | 🌐 Python | 📅 2026-09-10 (👨‍💻 34 · 🔀 440):

  ```
  git clone https://github.com/daviddrysdale/python-phonenumbers
  ```
* [PyPi](https://pypi.org/project/phonenumbers) (📥 37M / month · 📦 1K · ⏱️ 10.09.2026):
  ```
  pip install phonenumbers
  ```
* [Conda](https://anaconda.org/conda-forge/phonenumbers) (📥 2.6M · ⏱️ 28.08.2026):
  ```
  conda install -c conda-forge phonenumbers
  ```

</details>
<details><summary><b><a href="https://github.com/carpedm20/emoji">emoji</a></b> (🥈29 ·  ⭐ 2K · 💤) - emoji terminal output for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
* [GitHub](https://github.com/carpedm20/emoji) ⭐ 2,037 | 🐛 27 | 🌐 Python | 📅 2025-09-21 (👨‍💻 70 · 🔀 300 · 📦 93K):
  ...
  ```
* [PyPi](https://pypi.org/project/emoji) (📥 14M / month · 📦 1.3K · ⏱️ 21.09.2025):
  ```
  pip install emoji
  ```
* [Conda](https://anaconda.org/conda-forge/emoji) (📥 280K · ⏱️ 21.09.2025):
  ```
...
* [GitHub](https://github.com/jmoiron/humanize) ⭐ 1,705 | 🐛 0 | 🌐 Python | 📅 2022-07-17 (👨‍💻 62 · 🔀 150):
  ...
  ```
* [PyPi](https://pypi.org/project/humanize) (📥 56M / month · 📦 1.9K · ⏱️ 30.06.2026):
  ```
...
* [GitHub](https://github.com/WojciechMula/pyahocorasick) ⭐ 1,124 | 🐛 36 | 🌐 C | 📅 2026-04-27 (👨‍💻 33 · 🔀 140 · 📦 4.4K):

  ```
  git clone https://github.com/WojciechMula/pyahocorasick
  ```
* [PyPi](https://pypi.org/project/pyahocorasick) (📥 5.7M / month · 📦 270 · ⏱️ 27.04.2026):
  ```
  pip install pyahocorasick
  ```
* [Conda](https://anaconda.org/conda-forge/pyahocorasick) (📥 600K · ⏱️ 05.09.2026):
  ```
...
* [GitHub](https://github.com/alexanderlukanin13/coolname) ⭐ 185 | 🐛 3 | 🌐 Python | 📅 2026-07-24 (👨‍💻 7 · 🔀 16 · 📦 4.4K):

  ```
  git clone https://github.com/alexanderlukanin13/coolname
  ```
* [PyPi](https://pypi.org/project/coolname) (📥 8.5M / month · 📦 170 · ⏱️ 23.04.2026):
  ```
  pip install coolname
  ```
* [Conda](https://anaconda.org/conda-forge/coolname) (📥 270K · ⏱️ 29.05.2026):
  ```
...
* [GitHub](https://github.com/scrapinghub/price-parser) ⭐ 346 | 🐛 38 | 🌐 Python | 📅 2026-08-06 (👨‍💻 19 · 🔀 54 · 📦 560):

  ```
  git clone https://github.com/scrapinghub/price-parser
  ```
* [PyPi](https://pypi.org/project/price-parser) (📥 780K / month · 📦 40 · ⏱️ 19.03.2026):
  ```
...
* <b>[inflect](https://github.com/jaraco/inflect) ⭐ 1,084 | 🐛 64 | 🌐 Python | 📅 2026-04-13</b> (🥉27 ·  ⭐ 1.1K · 💀) - Correctly generate plurals, ordinals, indefinite articles; convert.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
🔗 <b>[best-of-web-python](https://github.com/ml-tooling/best-of-web-python) ⭐ 2,758 | 🐛 17 | 📅 2026-09-03</b> ( ⭐ 2.6K · 💤)  - A ranked list of awesome python libraries for web development...
...
* [GitHub](https://github.com/boto/boto3) ⭐ 9,900 | 🐛 193 | 🌐 Python | 📅 2026-09-09 (👨‍💻 170 · 🔀 2K · 📦 610K):

  ```
  git clone https://github.com/boto/boto3
  ```
* [PyPi](https://pypi.org/project/boto3) (📥 2.8B / month · 📦 23K · ⏱️ 09.09.2026):
  ```
  pip install boto3
  ```
* [Conda](https://anaconda.org/conda-forge/boto3) (📥 36M · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/sqlalchemy/sqlalchemy) ⭐ 12,150 | 🐛 202 | 🌐 Python | 📅 2026-09-10 (👨‍💻 860 · 🔀 1.8K · 📦 1.2M):

  ```
  git clone https://github.com/sqlalchemy/sqlalchemy
  ```
* [PyPi](https://pypi.org/project/SQLAlchemy) (📥 370M / month · 📦 23K · ⏱️ 08.09.2026):
  ```
  pip install SQLAlchemy
  ```
* [Conda](https://anaconda.org/conda-forge/sqlalchemy) (📥 32M · ⏱️ 12.08.2026):
  ```
...
* [GitHub](https://github.com/sqlalchemy/alembic) ⭐ 4,387 | 🐛 118 | 🌐 Python | 📅 2026-09-10 (👨‍💻 230 · 🔀 370 · 📦 350K):

  ```
  git clone https://github.com/sqlalchemy/alembic
  ```
* [PyPi](https://pypi.org/project/alembic) (📥 200M / month · 📦 4.9K · ⏱️ 04.09.2026):
  ```
  pip install alembic
  ```
* [Conda](https://anaconda.org/conda-forge/alembic) (📥 12M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/googleapis/python-bigquery) ⚠️ Archived (👨‍💻 180 · 🔀 320 · ⏱️ 06.03.2026):
  ...
  ```
* [PyPi](https://pypi.org/project/google-cloud-bigquery) (📥 160M / month · 📦 1.9K · ⏱️ 03.09.2026):
  ```
  pip install google-cloud-bigquery
  ```
* [Conda](https://anaconda.org/conda-forge/google-cloud-bigquery) (📥 4.1M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/redis/redis-py) ⭐ 13,632 | 🐛 79 | 🌐 Python | 📅 2026-09-10 (👨‍💻 580 · 🔀 2.7K):

  ```
  git clone https://github.com/redis/redis-py
  ```
* [PyPi](https://pypi.org/project/redis) (📥 220M / month · 📦 13K · ⏱️ 30.07.2026):
  ```
  pip install redis
  ```
* [Conda](https://anaconda.org/conda-forge/redis-py) (📥 2.9M · ⏱️ 31.07.2026):
  ```
  conda install -c conda-forge redis-py
  ```

</details>
<details><summary><b><a href="https://github.com/googleapis/python-bigquery-pandas">pandas-gbq</a></b> (🥇34 ·  ⭐ 5.4K) - This library has moved to https://github.com/googleapis/google-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
* [GitHub](https://github.com/googleapis/python-bigquery-pandas) ⚠️ Archived (👨‍💻 60 · 🔀 1.8K · 📥 720 · ⏱️ 13.03.2026):
  ...
  ```
* [PyPi](https://pypi.org/project/pandas-gbq) (📥 25M / month · 📦 300 · ⏱️ 25.08.2026):
  ```
...
* [GitHub](https://github.com/Azure/azure-sdk-for-python) ⭐ 5,597 | 🐛 1,117 | 🌐 Python | 📅 2026-09-10 (👨‍💻 1.3K · 🔀 3.4K · 📦 2.8K):

  ```
  git clone https://github.com/Azure/azure-sdk-for-python
  ```
* [PyPi](https://pypi.org/project/azure-storage-blob) (📥 110M / month · 📦 2.1K · ⏱️ 27.08.2026):
  ```
  pip install azure-storage-blob
  ```
* [Conda](https://anaconda.org/conda-forge/azure-storage-blob) (📥 2M · ⏱️ 27.08.2026):
  ```
...
* [GitHub](https://github.com/googleapis/google-cloud-python) ⭐ 5,383 | 🐛 536 | 🌐 Python | 📅 2026-09-10 (👨‍💻 1.1K · 🔀 1.8K):

  ```
  git clone https://github.com/googleapis/google-cloud-python
  ```
* [PyPi](https://pypi.org/project/google-cloud-storage) (📥 190M / month · 📦 3.4K · ⏱️ 08.09.2026):
  ```
  pip install google-cloud-storage
  ```
* [Conda](https://anaconda.org/conda-forge/google-cloud-storage) (📥 7.8M · ⏱️ 09.09.2026):
  ```
  conda install -c conda-forge google-cloud-storage
  ```

</details>
<details><summary><b><a href="https://github.com/googleapis/python-bigtable">google-cloud-bigtable</a></b> (🥈33 ·  ⭐ 5.4K) - This library has moved to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
* [GitHub](https://github.com/googleapis/python-bigtable) ⚠️ Archived (👨‍💻 80 · 🔀 1.8K · ⏱️ 01.04.2026):
  ...
  ```
* [PyPi](https://pypi.org/project/google-cloud-bigtable) (📥 46M / month · 📦 73 · ⏱️ 03.09.2026):
  ```
  pip install google-cloud-bigtable
  ```
* [Conda](https://anaconda.org/conda-forge/google-cloud-bigtable) (📥 250K · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/elastic/elasticsearch-py) ⭐ 4,386 | 🐛 63 | 🌐 Python | 📅 2026-09-09 (👨‍💻 230 · 🔀 1.2K · 📦 66K):

  ```
  git clone https://github.com/elastic/elasticsearch-py
  ```
* [PyPi](https://pypi.org/project/elasticsearch) (📥 44M / month · 📦 2.3K · ⏱️ 09.09.2026):
  ```
  pip install elasticsearch
  ```
* [Conda](https://anaconda.org/conda-forge/elasticsearch) (📥 2M · ⏱️ 10.09.2026):
  ```
...
* [GitHub](https://github.com/boto/s3transfer) ⭐ 239 | 🐛 73 | 🌐 Python | 📅 2026-09-08 (👨‍💻 49 · 🔀 160 · 📦 390K):

  ```
  git clone https://github.com/boto/s3transfer
  ```
* [PyPi](https://pypi.org/project/s3transfer) (📥 730M / month · 📦 940 · ⏱️ 22.07.2026):
  ```
  pip install s3transfer
  ```
* [Conda](https://anaconda.org/conda-forge/s3transfer) (📥 32M · ⏱️ 23.07.2026):
  ```
...
* [GitHub](https://github.com/coleifer/peewee) ⭐ 11,987 | 🐛 0 | 🌐 Python | 📅 2026-09-08 (👨‍💻 160 · 🔀 1.4K · 📦 24):

  ```
  git clone https://github.com/coleifer/peewee
  ```
* [PyPi](https://pypi.org/project/peewee) (📥 46M / month · 📦 1.4K · ⏱️ 08.09.2026):
  ```
  pip install peewee
  ```
* [Conda](https://anaconda.org/conda-forge/peewee) (📥 2.3M · ⏱️ 08.09.2026):
  ```
...
* [GitHub](https://github.com/PyMySQL/PyMySQL) ⭐ 7,842 | 🐛 18 | 🌐 Python | 📅 2026-09-10 (👨‍💻 130 · 🔀 1.4K · 📦 290K):

  ```
  git clone https://github.com/PyMySQL/PyMySQL
  ```
* [PyPi](https://pypi.org/project/PyMySQL) (📥 86M / month · 📦 2.7K · ⏱️ 19.05.2026):
  ```
  pip install PyMySQL
  ```
...
* [GitHub](https://github.com/dpkp/kafka-python) ⭐ 5,900 | 🐛 18 | 🌐 Python | 📅 2026-09-03 (👨‍💻 240 · 🔀 1.5K · 📦 37K):

  ```
  git clone https://github.com/dpkp/kafka-python
  ```
* [PyPi](https://pypi.org/project/kafka-python) (📥 21M / month · 📦 1.1K · ⏱️ 16.08.2026):
  ```
  pip install kafka-python
  ```
* [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 540K · ⏱️ 16.08.2026):
  ```
...
* [GitHub](https://github.com/mongodb/mongo-python-driver) ⭐ 4,357 | 🐛 16 | 🌐 Python | 📅 2026-09-10 (👨‍💻 260 · 🔀 1.2K):

  ```
  git clone https://github.com/mongodb/mongo-python-driver
  ```
* [PyPi](https://pypi.org/project/pymongo) (📥 83M / month · 📦 7.1K · ⏱️ 03.09.2026):
  ```
  pip install pymongo
  ```
* [Conda](https://anaconda.org/conda-forge/pymongo) (📥 7.7M · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/fsspec/s3fs) ⭐ 1,044 | 🐛 175 | 🌐 Python | 📅 2026-09-01 (👨‍💻 160 · 🔀 300 · 📦 29K):

  ```
  git clone https://github.com/fsspec/s3fs
  ```
* [PyPi](https://pypi.org/project/s3fs) (📥 460M / month · 📦 2.1K · ⏱️ 28.07.2026):
  ```
  pip install s3fs
  ```
...
* [GitHub](https://github.com/prometheus/client_python) ⭐ 4,371 | 🐛 151 | 🌐 Python | 📅 2026-08-13 (👨‍💻 180 · 🔀 870):

  ```
  git clone https://github.com/prometheus/client_python
  ```
* [PyPi](https://pypi.org/project/prometheus_client) (📥 150M / month · 📦 4.8K · ⏱️ 24.07.2026):
  ```
...
* [GitHub](https://github.com/confluentinc/confluent-kafka-python) ⭐ 509 | 🐛 221 | 🌐 Python | 📅 2026-09-10 (👨‍💻 150 · 🔀 960 · 📦 18K):

  ```
  git clone https://github.com/confluentinc/confluent-kafka-python
  ```
* [PyPi](https://pypi.org/project/confluent-kafka) (📥 51M / month · 📦 1.1K · ⏱️ 10.09.2026):
  ```
  pip install confluent-kafka
  ```
* [Conda](https://anaconda.org/conda-forge/python-confluent-kafka) (📥 2.1M · ⏱️ 04.09.2026):
  ```
...
* [GitHub]() (👨‍💻 120 · 🔀 880 · 📦 33K):
  ...
  ```
* [PyPi](https://pypi.org/project/sqlmodel) (📥 23M / month · 📦 2K · ⏱️ 28.08.2026):
  ```
  pip install sqlmodel
  ```
* [Conda](https://anaconda.org/conda-forge/sqlmodel) (📥 340K · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/tortoise/tortoise-orm) ⭐ 5,625 | 🐛 546 | 🌐 Python | 📅 2026-09-10 (👨‍💻 180 · 🔀 500 · 📦 11K):

  ```
  git clone https://github.com/tortoise/tortoise-orm
  ```
* [PyPi](https://pypi.org/project/tortoise-orm) (📥 500K / month · 📦 390 · ⏱️ 10.08.2026):
  ```
  pip install tortoise-orm
  ```
* [Conda](https://anaconda.org/conda-forge/tortoise-orm) (📥 73K · ⏱️ 10.08.2026):
  ```
...
* [GitHub](https://github.com/MongoEngine/mongoengine) ⭐ 4,351 | 🐛 318 | 🌐 Python | 📅 2026-09-06 (👨‍💻 400 · 🔀 1.2K · 📦 28K):
  ...
  ```
* [PyPi](https://pypi.org/project/mongoengine) (📥 2.1M / month · 📦 450 · ⏱️ 10.03.2026):
  ```
...
* [PyPi](https://pypi.org/project/awswrangler) (📥 86M / month · 📦 150 · ⏱️ 03.08.2026):
  ...
  ```
* [Conda](https://anaconda.org/conda-forge/awswrangler) (📥 930K · ⏱️ 04.08.2026):
  ```
...
* [GitHub]() (👨‍💻 220 · 🔀 580 · 📦 11K):
  ...
  ```
* [PyPi](https://pypi.org/project/cassandra-driver) (📥 5M / month · 📦 330 · ⏱️ 06.07.2026):
  ```
  pip install cassandra-driver
  ```
* [Conda](https://anaconda.org/conda-forge/cassandra-driver) (📥 700K · ⏱️ 11.07.2026):
  ```
...
* [GitHub](https://github.com/ibis-project/ibis) ⭐ 6,659 | 🐛 538 | 🌐 Python | 📅 2026-09-09 (👨‍💻 520 · 🔀 720 · 📦 5.4K):

  ```
  git clone https://github.com/ibis-project/ibis
  ```
* [PyPi](https://pypi.org/project/ibis-framework) (📥 3.8M / month · 📦 130 · ⏱️ 07.02.2026):
  ```
...
* [GitHub](https://github.com/ponyorm/pony) ⭐ 3,818 | 🐛 358 | 🌐 Python | 📅 2026-08-10 (👨‍💻 34 · 🔀 260 · 📦 4.7K):
  ...
  ```
* [PyPi](https://pypi.org/project/pony) (📥 620K / month · 📦 190 · ⏱️ 09.08.2026):
  ```
  pip install pony
  ```
...
<details><summary><b><a href="https://github.com/kayak/pypika">PyPika</a></b> (🥉28 ·  ⭐ 2.9K · 💤) - PyPika is a python SQL query builder that exposes the full.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

* [GitHub](https://github.com/kayak/pypika) ⭐ 2,928 | 🐛 232 | 🌐 Python | 📅 2026-02-04 (👨‍💻 120 · 🔀 330 · 📦 47K):

  ```
  git clone https://github.com/kayak/pypika
  ```
* [PyPi](https://pypi.org/project/pypika) (📥 10M / month · 📦 230 · ⏱️ 04.02.2026):
  ```
  pip install pypika
  ```
* [Conda](https://anaconda.org/conda-forge/pypika) (📥 120K · ⏱️ 02.02.2026):
  ```
...
* [GitHub](https://github.com/PyMySQL/mysqlclient) ⭐ 2,537 | 🐛 3 | 🌐 Python | 📅 2026-09-07 (👨‍💻 93 · 🔀 450 · 📦 210K):

  ```
  git clone https://github.com/PyMySQL/mysqlclient
  ```
* [PyPi](https://pypi.org/project/mysqlclient) (📥 18M / month · 📦 1.1K · ⏱️ 10.02.2026):
  ```
  pip install mysqlclient
  ```
* [Conda](https://anaconda.org/conda-forge/mysqlclient) (📥 1M · ⏱️ 03.03.2026):
  ```
...
* [GitHub](https://github.com/pudo/dataset) ⭐ 4,872 | 🐛 25 | 🌐 Python | 📅 2026-07-22 (👨‍💻 81 · 🔀 300 · 📦 5.2K):

  ```
  git clone https://github.com/pudo/dataset
  ```
* [PyPi](https://pypi.org/project/dataset) (📥 1.9M / month · 📦 150 · ⏱️ 12.04.2026):
  ```
  pip install dataset
  ```
...
* [GitHub](https://github.com/pynamodb/PynamoDB) ⭐ 2,646 | 🐛 319 | 🌐 Python | 📅 2026-05-29 (👨‍💻 120 · 🔀 430 · 📦 2K):

  ```
  git clone https://github.com/pynamodb/PynamoDB
  ```
* [PyPi](https://pypi.org/project/pynamodb) (📥 3.3M / month · 📦 86 · ⏱️ 02.06.2025):
  ```
  pip install pynamodb
  ```
* [Conda](https://anaconda.org/conda-forge/pynamodb) (📥 4.2M · ⏱️ 02.06.2025):
  ```
...
* [GitHub](https://github.com/kennethreitz/records) ⭐ 7,220 | 🐛 50 | 🌐 Python | 📅 2026-02-09 (👨‍💻 52 · 🔀 570 · 📦 1.3K):
  ...
  ```
* [PyPi](https://pypi.org/project/records) (📥 320K / month · 📦 47 · ⏱️ 29.03.2024):
  ```
  pip install records
  ```
* [Conda](https://anaconda.org/conda-forge/records) (📥 120K · ⏱️ 01.09.2026):
  ```
...
* [GitHub](https://github.com/apache/libcloud) ⭐ 2,124 | 🐛 93 | 🌐 Python | 📅 2026-09-10 (👨‍💻 500 · 🔀 930):

  ```
  git clone https://github.com/apache/libcloud
  ```
* [PyPi](https://pypi.org/project/apache-libcloud) (📥 790K / month · 📦 190 · ⏱️ 21.04.2026):
  ```
...
* [GitHub](https://github.com/piccolo-orm/piccolo) ⭐ 1,941 | 🐛 45 | 🌐 Python | 📅 2026-09-07 (👨‍💻 58 · 🔀 110 · 📦 550):

  ```
  git clone https://github.com/piccolo-orm/piccolo
  ```
* [PyPi](https://pypi.org/project/piccolo) (📥 880K / month · 📦 18 · ⏱️ 27.07.2026):
  ```
  pip install piccolo
  ```
...
* [GitHub](https://github.com/minio/minio-py) ⭐ 1,075 | 🐛 2 | 🌐 Python | 📅 2026-08-23 (👨‍💻 150 · 🔀 370):
  ...
  ```
* [PyPi](https://pypi.org/project/minio) (📥 10M / month · 📦 820 · ⏱️ 27.11.2025):
  ```
  pip install minio
  ```
* [Conda](https://anaconda.org/conda-forge/minio) (📥 400K · ⏱️ 27.11.2025):
  ```
...
* [GitHub](https://github.com/oracle/python-cx_Oracle) ⭐ 887 | 🐛 19 | 🌐 C | 📅 2025-05-26 (👨‍💻 17 · 🔀 360 · 📦 9.2K):
  ...
  ```
* [PyPi](https://pypi.org/project/cx-Oracle) (📥 2.8M / month · 📦 430 · ⏱️ 20.07.2023):
  ```
...
* [GitHub](https://github.com/django-haystack/pysolr) ⭐ 702 | 🐛 23 | 🌐 Python | 📅 2026-09-08 (👨‍💻 77 · 🔀 340 · 📦 4K):

  ```
  git clone https://github.com/django-haystack/pysolr
  ```
* [PyPi](https://pypi.org/project/pysolr) (📥 330K / month · 📦 87 · ⏱️ 18.11.2025):
  ```
  pip install pysolr
  ```
...
* [GitHub](https://github.com/art049/odmantic) ⭐ 1,175 | 🐛 118 | 🌐 Python | 📅 2026-05-19 (👨‍💻 23 · 🔀 97 · 📦 3.6K):
  ...
  ```
* [PyPi](https://pypi.org/project/odmantic) (📥 64K / month · 📦 24 · ⏱️ 24.01.2026):
  ```
...
* [GitHub](https://github.com/neo4j/neo4j-python-driver) ⭐ 1,048 | 🐛 7 | 🌐 Python | 📅 2026-09-04 (👨‍💻 45 · 🔀 210):

  ```
  git clone https://github.com/neo4j/neo4j-python-driver
  ```
* [PyPi](https://pypi.org/project/neo4j-driver) (📥 99K / month · 📦 65 · ⏱️ 28.08.2026):
  ```
  pip install neo4j-driver
  ```
* [Conda](https://anaconda.org/conda-forge/neo4j-python-driver) (📥 530K · ⏱️ 28.08.2026):
  ```
...
* [GitHub](https://github.com/python-happybase/happybase) ⭐ 609 | 🐛 34 | 🌐 Python | 📅 2026-03-16 (👨‍💻 22 · 🔀 160 · 📦 1K):

  ```
  git clone https://github.com/python-happybase/happybase
  ```
* [PyPi](https://pypi.org/project/happybase) (📥 61K / month · 📦 44 · ⏱️ 26.09.2025):
  ```
...
* [GitHub](https://github.com/Scille/umongo) ⭐ 447 | 🐛 50 | 🌐 Python | 📅 2026-09-07 (👨‍💻 19 · 🔀 68 · 📦 26K):
  ...
  ```
* [PyPi](https://pypi.org/project/umongo) (📥 28K / month · 📦 10 · ⏱️ 01.03.2026):
  ```
  pip install umongo
  ```
* [Conda](https://anaconda.org/conda-forge/umongo) (📥 20K · ⏱️ 20.08.2026):
  ```
...
* [GitHub](https://github.com/cloudant/python-cloudant) ⚠️ Archived (👨‍💻 33 · 🔀 55):
  ...
  ```
* [PyPi](https://pypi.org/project/cloudant) (📥 240K / month · 📦 34 · ⏱️ 26.08.2021):
  ```
...
* [GitHub](https://github.com/psycopg/psycopg) ⭐ 2,489 | 🐛 76 | 🌐 Python | 📅 2026-08-31 (👨‍💻 100 · 🔀 270):
...
* <b>[psycopg2](https://github.com/psycopg/psycopg2) ⭐ 3,654 | 🐛 16 | 🌐 C | 📅 2026-09-10</b> (🥈32 ·  ⭐ 3.7K) - PostgreSQL database adapter for the Python.. <code><a href="https://tldrlegal.com/search?q=BSD-3-Clause-Attribution">❗️BSD-3-Clause-Attribution</a></code>
* <b>[pyodbc](https://github.com/mkleehammer/pyodbc) ⭐ 3,080 | 🐛 61 | 🌐 C++ | 📅 2026-06-06</b> (🥉28 ·  ⭐ 3.1K) - Python ODBC bridge. <code><a href="https://tldrlegal.com/search?q=MIT-0">❗️MIT-0</a></code>
* <b>[gino](https://github.com/python-gino/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12</b> (🥉23 ·  ⭐ 2.7K · 💀) - GINO Is Not ORM - a Python asyncio ORM on SQLAlchemy core. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
* <b>[Motor](https://github.com/mongodb/motor) ⭐ 2,526 | 🐛 2 | 🌐 Python | 📅 2026-09-07</b> (🥈29 ·  ⭐ 2.5K · 💀) - Motor - the async Python driver for MongoDB and Tornado or asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
* <b>[influxdb](https://github.com/influxdata/influxdb-python) ⚠️ Archived</b> (🥉25 ·  ⭐ 1.7K · 💀) - Python client for InfluxDB. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b>[SQLAlchemy-Utils](https://github.com/kvesteri/sqlalchemy-utils) ⭐ 1,344 | 🐛 228 | 🌐 Python | 📅 2026-07-08</b> (🥉27 ·  ⭐ 1.3K) - Various utility functions and datatypes for SQLAlchemy. <code>❗Unlicensed</code>
...
* <b>[gsheets-db-api](https://github.com/betodealmeida/gsheets-db-api) ⭐ 222 | 🐛 15 | 🌐 Python | 📅 2022-12-08</b> (🥉10 ·  ⭐ 210 · 💀) - A Python DB-API and SQLAlchemy dialect to Google Spreasheets. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub](https://github.com/huggingface/datasets) ⭐ 21,963 | 🐛 1,356 | 🌐 Python | 📅 2026-09-10 (👨‍💻 700 · 🔀 3.3K · 📦 130K):

  ```
  git clone https://github.com/huggingface/datasets
  ```
* [PyPi](https://pypi.org/project/datasets) (📥 110M / month · 📦 7.1K · ⏱️ 28.07.2026):
  ```
  pip install datasets
  ```
* [Conda](https://anaconda.org/conda-forge/datasets) (📥 3.5M · ⏱️ 29.07.2026):
  ```
...
* [GitHub](https://github.com/joke2k/faker) ⭐ 19,397 | 🐛 27 | 🌐 Python | 📅 2026-09-01 (👨‍💻 680 · 🔀 2.1K · 📦 300K):

  ```
  git clone https://github.com/joke2k/faker
  ```
* [PyPi](https://pypi.org/project/Faker) (📥 72M / month · 📦 3.6K · ⏱️ 01.09.2026):
  ```
  pip install Faker
  ```
* [Conda](https://anaconda.org/conda-forge/faker) (📥 2.2M · ⏱️ 02.09.2026):
  ```
...
* [PyPi](https://pypi.org/project/python-magic) (📥 32M / month · 📦 1.5K · ⏱️ 07.06.2022):
  ...
  ```
* [Conda](https://anaconda.org/conda-forge/python-magic) (📥 970K · ⏱️ 19.06.2026):
  ```
...
* [GitHub](https://github.com/martinblech/xmltodict) ⭐ 5,754 | 🐛 5 | 🌐 Python | 📅 2026-08-19 (👨‍💻 60 · 🔀 470 · 📦 89K):

  ```
  git clone https://github.com/martinblech/xmltodict
  ```
* [PyPi](https://pypi.org/project/xmltodict) (📥 110M / month · 📦 3.9K · ⏱️ 22.02.2026):
  ```
  pip install xmltodict
  ```
* [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 7.5M · ⏱️ 22.02.2026):
  ```
...
* [GitHub](https://github.com/wkentaro/gdown) ⭐ 5,424 | 🐛 0 | 🌐 Python | 📅 2026-09-07 (👨‍💻 27 · 🔀 430 · 📦 60K):

  ```
  git clone https://github.com/wkentaro/gdown
  ```
* [PyPi](https://pypi.org/project/gdown) (📥 3.2M / month · 📦 1.5K · ⏱️ 06.09.2026):
  ```
  pip install gdown
  ```
* [Conda](https://anaconda.org/conda-forge/gdown) (📥 580K · ⏱️ 06.09.2026):
  ```
...
* [GitHub](https://github.com/xlwings/xlwings) ⭐ 3,403 | 🐛 405 | 🌐 Python | 📅 2026-09-10 (👨‍💻 69 · 🔀 540 · 📦 34K):

  ```
  git clone https://github.com/xlwings/xlwings
  ```
* [PyPi](https://pypi.org/project/xlwings) (📥 820K / month · 📦 310 · ⏱️ 09.09.2026):
  ```
  pip install xlwings
  ```
...
* [GitHub](https://github.com/jazzband/tablib) ⭐ 4,756 | 🐛 54 | 🌐 Python | 📅 2026-07-31 (👨‍💻 140 · 🔀 620 · 📦 130K):
...
* [GitHub](https://github.com/deanmalmgren/textract) ⭐ 4,713 | 🐛 57 | 🌐 HTML | 📅 2026-09-01 (👨‍💻 48 · 🔀 720 · 📦 4.9K):

  ```
  git clone https://github.com/deanmalmgren/textract
  ```
* [PyPi](https://pypi.org/project/textract) (📥 330K / month · 📦 97 · ⏱️ 01.09.2026):
  ```
  pip install textract
  ```
* [Conda](https://anaconda.org/conda-forge/textract) (📥 150K · ⏱️ 01.09.2026):
  ```
...
* [GitHub]() (👨‍💻 130 · 🔀 390):
  ...
  ```
* [PyPi](https://pypi.org/project/smart-open) (📥 66M / month · 📦 700 · ⏱️ 15.07.2026):
  ```
  pip install smart-open
  ```
* [Conda](https://anaconda.org/conda-forge/smart_open) (📥 5.2M · ⏱️ 15.07.2026):
  ```
...
* [GitHub](https://github.com/wireservice/csvkit) ⭐ 6,411 | 🐛 41 | 🌐 Python | 📅 2026-08-03 (👨‍💻 120 · 🔀 670 · 📦 2K):

  ```
  git clone https://github.com/wireservice/csvkit
  ```
* [PyPi](https://pypi.org/project/csvkit) (📥 270K / month · 📦 49 · ⏱️ 15.12.2025):
  ```
  pip install csvkit
  ```
...
<details><summary><b><a href="https://github.com/intake/intake">Intake</a></b> (🥈24 ·  ⭐ 1.1K · 📉) - Intake is a lightweight package for finding, investigating, loading.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

* [GitHub](https://github.com/intake/intake) ⭐ 1,085 | 🐛 115 | 🌐 Python | 📅 2026-09-08 (👨‍💻 96 · 🔀 150 · 📦 3.7K):

  ```
  git clone https://github.com/intake/intake
  ```
* [PyPi](https://pypi.org/project/intake) (📥 98K / month · 📦 230 · ⏱️ 17.06.2026):
  ```
  pip install intake
  ```
* [Conda](https://anaconda.org/conda-forge/intake) (📥 950K · ⏱️ 09.03.2026):
  ```
  conda install -c conda-forge intake
  ```

</details>
<details><summary><b><a href="https://github.com/rom1504/img2dataset">img2dataset</a></b> (🥉23 ·  ⭐ 4.2K · 💤) - Easily turn large sets of image urls to an image dataset. Can.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

* [GitHub](https://github.com/rom1504/img2dataset) ⭐ 4,448 | 🐛 145 | 🌐 Python | 📅 2025-10-19 (👨‍💻 36 · 🔀 360 · 📦 290):

  ```
  git clone https://github.com/rom1504/img2dataset
  ```
* [PyPi](https://pypi.org/project/img2dataset) (📥 77K / month · 📦 6 · ⏱️ 09.08.2025):
  ```
...
* [GitHub](https://github.com/camelot-dev/camelot) ⭐ 3,818 | 🐛 53 | 🌐 Python | 📅 2026-09-02 (👨‍💻 80 · 🔀 540 · 📦 3.7K):

  ```
  git clone https://github.com/camelot-dev/camelot
  ```
* [PyPi](https://pypi.org/project/camelot) (📥 3K / month · 📦 6 · ⏱️ 15.12.2021):
  ```
  pip install camelot
  ```
...
* [GitHub](https://github.com/snorkel-team/snorkel) ⭐ 6,005 | 🐛 19 | 🌐 Python | 📅 2026-06-08 (👨‍💻 81 · 🔀 850 · 📦 680):

  ```
  git clone https://github.com/snorkel-team/snorkel
  ```
* [PyPi](https://pypi.org/project/snorkel) (📥 39K / month · 📦 22 · ⏱️ 27.02.2024):
  ```
  pip install snorkel
  ```
...
* [GitHub](https://github.com/singer-io/getting-started) ⭐ 1,348 | 🐛 29 | 🌐 Makefile | 📅 2025-08-08 (👨‍💻 33 · 🔀 150):

  ```
  git clone https://github.com/singer-io/getting-started
  ```
* [PyPi](https://pypi.org/project/singer-python) (📥 600K / month · 📦 310 · ⏱️ 27.02.2026):
  ```
...
* [GitHub](https://github.com/upgini/upgini) ⭐ 357 | 🐛 1 | 🌐 Python | 📅 2026-09-01 (👨‍💻 14 · 🔀 26 · 📦 11):

  ```
  git clone https://github.com/upgini/upgini
  ```
* [PyPi](https://pypi.org/project/upgini) (📥 14K / month · ⏱️ 02.09.2026):
  ```
  pip install upgini
  ```
...
* [GitHub](https://github.com/turicas/rows) ⭐ 886 | 🐛 160 | 🌐 Python | 📅 2026-08-08 (👨‍💻 32 · 🔀 140 · 📦 180):
  ...
  ```
* [PyPi](https://pypi.org/project/rows) (📥 5.6K / month · 📦 6 · ⏱️ 15.12.2021):
  ```
  pip install rows
  ```
...
* <b>[SDV](https://github.com/sdv-dev/SDV) ⭐ 3,554 | 🐛 161 | 🌐 Python | 📅 2026-09-10</b> (🥈24 ·  ⭐ 3.6K) - Synthetic data generation for tabular data. <code>❗Unlicensed</code>
* <b>[pandas-datareader](https://github.com/pydata/pandas-datareader) ⭐ 3,264 | 🐛 147 | 🌐 Python | 📅 2026-07-21</b> (🥈26 ·  ⭐ 3.2K) - Extract data from a wide range of Internet sources.. <code>❗Unlicensed</code>
...
* <b>[pdfmux](https://github.com/NameetP/pdfmux) ⭐ 82 | 🐛 4 | 🌐 Python | 📅 2026-09-06</b> (🥉15 ·  ⭐ 77 · 🐣) - PDF extraction that audits its own output and certifies.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>python</code> <code>pdf</code> <code>markdown</code>
* <b>[Wayback-Archive](https://github.com/GeiserX/Wayback-Archive) ⭐ 32 | 🐛 1 | 🌐 Python | 📅 2026-08-24</b> (🥉6 ·  ⭐ 27 · 🐣) - Download complete websites from the Wayback Machine with.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
* [GitHub](https://github.com/apache/airflow) ⭐ 46,808 | 🐛 2,108 | 🌐 Python | 📅 2026-09-10 (👨‍💻 4.6K · 🔀 18K · 📦 20K):

  ```
  git clone https://github.com/apache/airflow
  ```
* [PyPi](https://pypi.org/project/apache-airflow) (📥 13M / month · 📦 970 · ⏱️ 12.08.2026):
  ```
  pip install apache-airflow
  ```
* [Conda](https://anaconda.org/conda-forge/airflow) (📥 2.2M · ⏱️ 20.08.2026):
  ```
...
* [GitHub](https://github.com/celery/celery) ⭐ 28,874 | 🐛 731 | 🌐 Python | 📅 2026-09-10 (👨‍💻 1.6K · 🔀 5.1K · 📦 190K):

  ```
  git clone https://github.com/celery/celery
  ```
* [PyPi](https://pypi.org/project/celery) (📥 50M / month · 📦 2.6K · ⏱️ 26.03.2026):
  ```
  pip install celery
  ```
...
<details><summary><b><a href="https://github.com/joblib/joblib">joblib</a></b> (🥇35 ·  ⭐ 4.4K) - Computing with Python functions. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

* [GitHub](https://github.com/joblib/joblib) ⭐ 4,390 | 🐛 436 | 🌐 Python | 📅 2026-09-09 (👨‍💻 160 · 🔀 470 · 📦 750K):

  ```
  git clone https://github.com/joblib/joblib
  ```
* [PyPi](https://pypi.org/project/joblib) (📥 190M / month · 📦 12K · ⏱️ 31.08.2026):
  ```
  pip install joblib
  ```
* [Conda](https://anaconda.org/conda-forge/joblib) (📥 53M · ⏱️ 31.08.2026):
  ```
...
* [GitHub](https://github.com/rq/rq) ⭐ 10,680 | 🐛 252 | 🌐 Python | 📅 2026-09-06 (👨‍💻 360 · 🔀 1.5K · 📦 22K):

  ```
  git clone https://github.com/rq/rq
  ```
* [PyPi](https://pypi.org/project/rq) (📥 13M / month · 📦 440 · ⏱️ 30.08.2026):
  ```
  pip install rq
  ```
...
* [GitHub](https://github.com/apache/beam) ⭐ 8,659 | 🐛 3,967 | 🌐 Java | 📅 2026-09-10 (👨‍💻 2K · 🔀 4.6K · 📦 9.8K):

  ```
  git clone https://github.com/apache/beam
  ```
* [PyPi](https://pypi.org/project/apache-beam) (📥 4.3M / month · 📦 190 · ⏱️ 31.08.2026):
  ```
...
* [GitHub](https://github.com/PrefectHQ/prefect) ⭐ 23,814 | 🐛 865 | 🌐 Python | 📅 2026-09-10 (👨‍💻 760 · 🔀 2.5K · 📦 8.5K):

  ```
  git clone https://github.com/PrefectHQ/prefect
  ```
* [PyPi](https://pypi.org/project/prefect) (📥 9.8M / month · 📦 570 · ⏱️ 10.09.2026):
  ```
  pip install prefect
  ```
* [Conda](https://anaconda.org/conda-forge/prefect) (📥 1.3M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/dagster-io/dagster) ⭐ 16,136 | 🐛 2,596 | 🌐 Python | 📅 2026-09-10 (👨‍💻 700 · 🔀 2.3K · 📦 4.9K):

  ```
  git clone https://github.com/dagster-io/dagster
  ```
* [PyPi](https://pypi.org/project/dagster) (📥 9.2M / month · 📦 430 · ⏱️ 03.09.2026):
  ```
  pip install dagster
  ```
* [Conda](https://anaconda.org/conda-forge/dagster) (📥 3.3M · ⏱️ 03.09.2026):
  ```
...
* [GitHub](https://github.com/spotify/luigi) ⭐ 18,772 | 🐛 170 | 🌐 Python | 📅 2026-07-18 (👨‍💻 640 · 🔀 2.5K · 📦 2.9K):

  ```
  git clone https://github.com/spotify/luigi
  ```
* [PyPi](https://pypi.org/project/luigi) (📥 970K / month · 📦 180 · ⏱️ 07.05.2026):
  ```
  pip install luigi
  ```
* [Conda](https://anaconda.org/anaconda/luigi) (📥 27K · 📦 3 · ⏱️ 02.09.2026):
  ```
...
* [GitHub](https://github.com/dbt-labs/dbt-core) ⭐ 13,801 | 🐛 1,512 | 🌐 Rust | 📅 2026-09-10 (👨‍💻 520 · 🔀 2.6K · 📦 10K):

  ```
  git clone https://github.com/dbt-labs/dbt-core
  ```
* [PyPi](https://pypi.org/project/dbt) (📥 120K / month · 📦 36 · ⏱️ 03.09.2026):
  ```
  pip install dbt
  ```
...
* [GitHub]() (👨‍💻 490 · 🔀 1.8K · 📦 4):
  ...
  ```
* [PyPi](https://pypi.org/project/great_expectations) (📥 23M / month · 📦 190 · ⏱️ 31.08.2026):
  ```
  pip install great_expectations
  ```
* [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 1.7M · ⏱️ 31.08.2026):
  ```
...
* [GitHub](https://github.com/kedro-org/kedro) ⭐ 10,989 | 🐛 138 | 🌐 Python | 📅 2026-09-10 (👨‍💻 300 · 🔀 1.1K · 📦 3.3K):

  ```
  git clone https://github.com/kedro-org/kedro
  ```
* [PyPi](https://pypi.org/project/kedro) (📥 1.2M / month · 📦 170 · ⏱️ 09.09.2026):
  ```
  pip install kedro
  ```
...
* [GitHub](https://github.com/petl-developers/petl) ⭐ 1,317 | 🐛 84 | 🌐 Python | 📅 2026-09-09 (👨‍💻 74 · 🔀 210 · 📦 4.4K):

  ```
  git clone https://github.com/petl-developers/petl
  ```
* [PyPi](https://pypi.org/project/petl) (📥 780K / month · 📦 57 · ⏱️ 09.09.2026):
  ```
  pip install petl
  ```
* [Conda](https://anaconda.org/conda-forge/petl) (📥 540K · ⏱️ 09.09.2026):
  ```
...
* [GitHub](https://github.com/zenml-io/zenml) ⭐ 5,580 | 🐛 165 | 🌐 Python | 📅 2026-09-10 (👨‍💻 160 · 🔀 650 · 📦 1.5K):

  ```
  git clone https://github.com/zenml-io/zenml
  ```
* [PyPi](https://pypi.org/project/zenml) (📥 150K / month · 📦 15 · ⏱️ 04.09.2026):
  ```
  pip install zenml
  ```
...
* [GitHub]() (👨‍💻 67 · 🔀 210 · 📦 1.5K):
  ...
  ```
* [PyPi](https://pypi.org/project/arq) (📥 4.4M / month · 📦 82 · ⏱️ 16.04.2026):
  ```
  pip install arq
  ```
...
* [GitHub](https://github.com/coleifer/huey) ⭐ 6,032 | 🐛 0 | 🌐 Python | 📅 2026-09-08 (👨‍💻 72 · 🔀 400):

  ```
  git clone https://github.com/coleifer/huey
  ```
* [PyPi](https://pypi.org/project/huey) (📥 19M / month · 📦 160 · ⏱️ 04.09.2026):
  ```
  pip install huey
  ```
* [Conda](https://anaconda.org/conda-forge/huey) (📥 230K · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/combust/mleap) ⭐ 1,543 | 🐛 111 | 🌐 Scala | 📅 2026-07-21 (👨‍💻 87 · 🔀 320 · 📦 250):

  ```
  git clone https://github.com/combust/mleap
  ```
* [PyPi](https://pypi.org/project/mleap) (📥 1.9M / month · 📦 11 · ⏱️ 21.07.2026):
  ```
  pip install mleap
  ```
...
* [GitHub](https://github.com/cocoindex-io/cocoindex) ⭐ 11,521 | 🐛 79 | 🌐 Rust | 📅 2026-09-10 (👨‍💻 93 · 🔀 450 · 📦 72):

  ```
  git clone https://github.com/cocoindex-io/cocoindex
  ```
* [PyPi](https://pypi.org/project/cocoindex) (📥 77K / month · 📦 20 · ⏱️ 10.09.2026):
  ```
...
* [GitHub](https://github.com/closeio/tasktiger) ⭐ 1,466 | 🐛 50 | 🌐 Python | 📅 2026-08-31 (👨‍💻 35 · 🔀 95 · 📦 33):

  ```
  git clone https://github.com/closeio/tasktiger
  ```
* [PyPi](https://pypi.org/project/tasktiger) (📥 9.8K / month · 📦 2 · ⏱️ 31.08.2026):
  ```
...
* [GitHub](https://github.com/nerevu/riko) ⭐ 1,606 | 🐛 25 | 🌐 Python | 📅 2026-09-10 (👨‍💻 25 · 🔀 75 · 📦 14):

  ```
  git clone https://github.com/nerevu/riko
  ```
* [PyPi](https://pypi.org/project/riko) (📥 1.2K / month · ⏱️ 01.09.2026):
  ```
  pip install riko
  ```
...
* [GitHub](https://github.com/databand-ai/dbnd) ⭐ 267 | 🐛 27 | 🌐 Python | 📅 2026-03-04 (👨‍💻 93 · 🔀 33 · 📦 42):
  ...
  ```
* [PyPi](https://pypi.org/project/dbnd) (📥 21K / month · 📦 27 · ⏱️ 05.03.2026):
  ```
  pip install dbnd
  ```
...
* [GitHub](https://github.com/pdpipe/pdpipe) ⭐ 731 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-08-01 (👨‍💻 14 · 🔀 46 · 📦 67):
  ...
  ```
* [PyPi](https://pypi.org/project/pdpipe) (📥 1.3K / month · 📦 14 · ⏱️ 06.03.2026):
  ```
  pip install pdpipe
  ```
...
* [GitHub](https://github.com/analysiscenter/batchflow) ⭐ 205 | 🐛 44 | 🌐 Python | 📅 2026-07-10 (👨‍💻 40 · 🔀 45 · 📦 15):
  ...
  ```
* [PyPi](https://pypi.org/project/batchflow) (📥 590 / month · ⏱️ 16.04.2026):
  ```
...
* [GitHub]() (👨‍💻 29 · 🔀 160):
  ...
  ```
* [PyPi](https://pypi.org/project/kubeflow-kale) (📥 1.7K / month · ⏱️ 07.08.2026):
  ```
...
* <b>[faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27</b> (🥉22 ·  ⭐ 6.8K · 💀) - Python Stream Processing. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
* <b>[whylogs](https://github.com/whylabs/whylogs) ⭐ 2,832 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-01-10</b> (🥉22 ·  ⭐ 2.8K · 💀) - Open standard for end-to-end data and ML monitoring for any.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
* <b>[PyFunctional](https://github.com/EntilZha/PyFunctional) ⭐ 2,487 | 🐛 12 | 🌐 Python | 📅 2025-03-13</b> (🥉23 ·  ⭐ 2.3K · 💀) - Python library for creating data pipelines with chain.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[Mara Pipelines](https://github.com/mara/mara-pipelines) ⭐ 2,090 | 🐛 26 | 🌐 Python | 📅 2023-12-15</b> (🥉13 ·  ⭐ 2.1K · 💀) - A lightweight opinionated ETL framework, halfway between.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b>[Pypeline](https://github.com/cgarciae/pypeln) ⭐ 1,598 | 🐛 35 | 🌐 Python | 📅 2023-07-20</b> (🥉20 ·  ⭐ 1.4K · 💀) - Concurrent data pipelines in Python . <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b>[streamparse](https://github.com/Parsely/streamparse) ⭐ 1,504 | 🐛 61 | 🌐 Python | 📅 2026-04-22</b> (🥉17 ·  ⭐ 1.5K · 💀) - streamparse lets you run Python code against real-time.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
* <b>[Botflow](https://github.com/kkyon/botflow) ⭐ 1,194 | 🐛 4 | 🌐 Python | 📅 2026-02-03</b> (🥉13 ·  ⭐ 740 · 💀) - Python Fast Data driven programming framework for Data pipeline.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
* [GitHub](https://github.com/yaml/pyyaml) ⭐ 2,940 | 🐛 366 | 🌐 Python | 📅 2026-06-17 (👨‍💻 40 · 🔀 570 · 📦 1.9M):

  ```
  git clone https://github.com/yaml/pyyaml
  ```
* [PyPi](https://pypi.org/project/pyyaml) (📥 1B / month · 📦 55K · ⏱️ 25.09.2025):
  ```
  pip install pyyaml
  ```
* [Conda](https://anaconda.org/conda-forge/pyyaml) (📥 95M · ⏱️ 04.02.2026):
  ```
...
* [GitHub](https://github.com/jmcnamara/XlsxWriter) ⭐ 3,972 | 🐛 30 | 🌐 Python | 📅 2026-08-04 (👨‍💻 58 · 🔀 660 · 📦 110K):

  ```
  git clone https://github.com/jmcnamara/XlsxWriter
  ```
* [PyPi](https://pypi.org/project/xlsxwriter) (📥 92M / month · 📦 470 · ⏱️ 16.09.2025):
  ```
  pip install xlsxwriter
  ```
* [Conda](https://anaconda.org/conda-forge/xlsxwriter) (📥 5.3M · ⏱️ 12.10.2025):
  ```
...
* [GitHub](https://github.com/jmespath/jmespath.py) ⭐ 2,449 | 🐛 76 | 🌐 Python | 📅 2026-04-20 (👨‍💻 32 · 🔀 190):

  ```
  git clone https://github.com/jmespath/jmespath.py
  ```
* [PyPi](https://pypi.org/project/jmespath) (📥 570M / month · 📦 2K · ⏱️ 22.01.2026):
  ```
...
* [GitHub]() (👨‍💻 110 · 🔀 270 · 📦 22K):
  ...
  ```
* [PyPi](https://pypi.org/project/deepdiff) (📥 65M / month · 📦 1.5K · ⏱️ 15.05.2026):
  ```
  pip install deepdiff
  ```
* [Conda](https://anaconda.org/conda-forge/deepdiff) (📥 980K · ⏱️ 16.05.2026):
  ```
...
* [GitHub](https://github.com/jd/tenacity) ⭐ 8,780 | 🐛 50 | 🌐 Python | 📅 2026-09-01 (👨‍💻 120 · 🔀 320 · 📦 410K):

  ```
  git clone https://github.com/jd/tenacity
  ```
* [PyPi](https://pypi.org/project/tenacity) (📥 400M / month · 📦 6.3K · ⏱️ 07.02.2026):
  ```
...
* [GitHub](https://github.com/python-attrs/attrs) ⭐ 5,836 | 🐛 154 | 🌐 Python | 📅 2026-09-01 (👨‍💻 190 · 🔀 420 · 📦 1.5M):

  ```
  git clone https://github.com/python-attrs/attrs
  ```
* [PyPi](https://pypi.org/project/attrs) (📥 800M / month · 📦 11K · ⏱️ 19.03.2026):
  ```
  pip install attrs
  ```
* [Conda](https://anaconda.org/conda-forge/attrs) (📥 77M · ⏱️ 19.03.2026):
  ```
...
* [GitHub](https://github.com/more-itertools/more-itertools) ⭐ 4,090 | 🐛 19 | 🌐 Python | 📅 2026-09-10 (👨‍💻 160 · 🔀 320 · 📦 300K):

  ```
  git clone https://github.com/more-itertools/more-itertools
  ```
* [PyPi](https://pypi.org/project/more-itertools) (📥 270M / month · 📦 5K · ⏱️ 22.05.2026):
  ```
...
* [GitHub](https://github.com/mahmoud/boltons) ⭐ 6,920 | 🐛 75 | 🌐 Python | 📅 2026-09-08 (👨‍💻 120 · 🔀 420 · 📦 12K):

  ```
  git clone https://github.com/mahmoud/boltons
  ```
* [PyPi](https://pypi.org/project/boltons) (📥 25M / month · 📦 460 · ⏱️ 07.09.2026):
  ```
  pip install boltons
  ```
* [Conda](https://anaconda.org/conda-forge/boltons) (📥 17M · ⏱️ 08.09.2026):
  ```
  conda install -c conda-forge boltons
  ```

</details>
<details><summary><b><a href="https://github.com/ets-labs/python-dependency-injector">python-dependency-injector</a></b> (🥈28 ·  ⭐ 4.9K) - Dependency injection framework for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

* [GitHub](https://github.com/ets-labs/python-dependency-injector) ⭐ 4,911 | 🐛 212 | 🌐 Python | 📅 2026-09-01 (👨‍💻 49 · 🔀 350 · 📦 5.9K):

  ```
  git clone https://github.com/ets-labs/python-dependency-injector
  ```
* [PyPi](https://pypi.org/project/dependency-injector) (📥 8.3M / month · 📦 420 · ⏱️ 18.06.2026):
  ```
...
* [GitHub](https://github.com/Suor/funcy) ⭐ 3,508 | 🐛 12 | 🌐 Python | 📅 2026-09-10 (👨‍💻 39 · 🔀 160 · 📦 16K):

  ```
  git clone https://github.com/Suor/funcy
  ```
* [PyPi](https://pypi.org/project/funcy) (📥 6.8M / month · 📦 450 · ⏱️ 10.09.2026):
  ```
  pip install funcy
  ```
* [Conda](https://anaconda.org/conda-forge/funcy) (📥 1.1M · ⏱️ 10.09.2026):
  ```
...
* [GitHub](https://github.com/dry-python/returns) ⭐ 4,359 | 🐛 81 | 🌐 Python | 📅 2026-09-10 (👨‍💻 74 · 🔀 150 · 📦 1.1K):

  ```
  git clone https://github.com/dry-python/returns
  ```
* [PyPi](https://pypi.org/project/returns) (📥 1.6M / month · 📦 240 · ⏱️ 02.08.2026):
  ```
  pip install returns
  ```
* [Conda](https://anaconda.org/conda-forge/returns) (📥 98K · ⏱️ 03.08.2026):
  ```
...
* [GitHub](https://github.com/SethMMorton/natsort) ⭐ 1,012 | 🐛 9 | 🌐 Python | 📅 2026-09-10 (👨‍💻 26 · 🔀 52 · 📦 50K):

  ```
  git clone https://github.com/SethMMorton/natsort
  ```
* [PyPi](https://pypi.org/project/natsort) (📥 19M / month · 📦 1.5K · ⏱️ 20.06.2023):
  ```
  pip install natsort
  ```
* [Conda](https://anaconda.org/conda-forge/natsort) (📥 3.2M · ⏱️ 12.02.2026):
  ```
...
* [GitHub](https://github.com/Erotemic/ubelt) ⭐ 740 | 🐛 11 | 🌐 Python | 📅 2026-07-31 (👨‍💻 6 · 🔀 51):
  ...
  ```
* [PyPi](https://pypi.org/project/ubelt) (📥 48K / month · 📦 140 · ⏱️ 31.07.2026):
  ```
  pip install ubelt
  ```
* [Conda](https://anaconda.org/conda-forge/ubelt) (📥 460K · ⏱️ 06.09.2026):
  ```
...
* <b>[toolz](https://github.com/pytoolz/toolz) ⭐ 5,156 | 🐛 138 | 🌐 Python | 📅 2026-01-01</b> (🥈28 ·  ⭐ 5.1K · 💤) - A functional standard library for Python. <code>❗Unlicensed</code>
...
* <b>[retrying](https://github.com/rholder/retrying) ⭐ 1,922 | 🐛 50 | 🌐 Python | 📅 2021-08-15</b> (🥉26 ·  ⭐ 1.9K · 💀) - Retrying is an Apache 2.0 licensed general-purpose retrying.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
* <b>[ratelimit](https://github.com/tomasbasham/ratelimit) ⭐ 832 | 🐛 32 | 🌐 Python | 📅 2026-04-13</b> (🥉25 ·  ⭐ 760 · 💀) - API Rate Limit Decorator. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [GitHub](https://github.com/python/cpython) ⭐ 76,428 | 🐛 9,645 | 🌐 Python | 📅 2026-09-10 (👨‍💻 4K · 🔀 35K · 📦 630K):

  ```
  git clone https://github.com/python/cpython
  ```
* [PyPi](https://pypi.org/project/cpython) (📥 12 / month · 📦 21 · ⏱️ 22.07.2020):
  ```
  pip install cpython
  ```
* [Conda](https://anaconda.org/conda-forge/typing) (📥 4.5M · ⏱️ 22.04.2025):
...
* [GitHub](https://github.com/micropython/micropython) ⭐ 22,054 | 🐛 1,525 | 🌐 C | 📅 2026-09-09 (👨‍💻 760 · 🔀 8.9K · 📦 21):
...
* [GitHub](https://github.com/pygments/pygments) ⭐ 2,207 | 🐛 658 | 🌐 Python | 📅 2026-08-17 (👨‍💻 950 · 🔀 870 · 📦 1.2M):

  ```
  git clone https://github.com/pygments/pygments
  ```
* [PyPi](https://pypi.org/project/pygments) (📥 1.1B / month · 📦 12K · ⏱️ 17.08.2026):
  ```
  pip install pygments
  ```
* [Conda](https://anaconda.org/conda-forge/pygments) (📥 72M · ⏱️ 17.08.2026):
  ```
...
* [GitHub](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,302 | 🐛 1 | 🌐 Python | 📅 2026-09-04 (👨‍💻 40 · 🔀 250 · 📦 630K):

  ```
  git clone https://github.com/GrahamDumpleton/wrapt
  ```
* [PyPi](https://pypi.org/project/wrapt) (📥 430M / month · 📦 3.4K · ⏱️ 04.09.2026):
  ```
  pip install wrapt
  ```
* [Conda](https://anaconda.org/conda-forge/wrapt) (📥 42M · ⏱️ 04.09.2026):
  ```
...
* [GitHub](https://github.com/pyparsing/pyparsing) ⭐ 2,489 | 🐛 42 | 🌐 Python | 📅 2026-08-18 (👨‍💻 84 · 🔀 320 · 📦 1.3M):

  ```
  git clone https://github.com/pyparsing/pyparsing
  ```
* [PyPi](https://pypi.org/project/pyparsing) (📥 350M / month · 📦 6.3K · ⏱️ 21.01.2026):
  ```
  pip install pyparsing
  ```
* [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 78M · ⏱️ 21.01.2026):
  ```
...
* [GitHub](https://github.com/cookiecutter/cookiecutter) ⭐ 25,085 | 🐛 311 | 🌐 Python | 📅 2026-04-01 (👨‍💻 330 · 🔀 2.2K · 📦 38K):

  ```
  git clone https://github.com/cookiecutter/cookiecutter
  ```
* [PyPi](https://pypi.org/project/cookiecutter) (📥 8.5M / month · 📦 1.2K · ⏱️ 04.03.2026):
  ```
  pip install cookiecutter
  ```
* [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 2.3M · ⏱️ 04.03.2026):
  ```
...
* [GitHub](https://github.com/pytest-dev/pluggy) ⭐ 1,690 | 🐛 55 | 🌐 Python | 📅 2026-09-08 (👨‍💻 62 · 🔀 150 · 📦 830K):

  ```
  git clone https://github.com/pytest-dev/pluggy
  ```
* [PyPi](https://pypi.org/project/pluggy) (📥 1.1B / month · 📦 2.6K · ⏱️ 15.05.2025):
  ```
  pip install pluggy
  ```
* [Conda](https://anaconda.org/conda-forge/pluggy) (📥 59M · ⏱️ 05.12.2025):
  ```
...
* [GitHub](https://github.com/micheles/decorator) ⭐ 904 | 🐛 5 | 🌐 Python | 📅 2026-07-09 (👨‍💻 33 · 🔀 120 · 📦 770K):

  ```
  git clone https://github.com/micheles/decorator
  ```
* [PyPi](https://pypi.org/project/decorator) (📥 170M / month · 📦 2.9K · ⏱️ 18.05.2026):
  ```
...
* [GitHub](https://github.com/mingrammer/diagrams) ⭐ 42,608 | 🐛 389 | 🌐 Python | 📅 2026-09-10 (👨‍💻 180 · 🔀 2.7K · 📦 2.5K):

  ```
  git clone https://github.com/mingrammer/diagrams
  ```
* [PyPi](https://pypi.org/project/diagrams) (📥 3.5M / month · 📦 140 · ⏱️ 22.11.2025):
  ```
...
* [GitHub]() (👨‍💻 84 · 🔀 300 · 📦 13K):
  ...
  ```
* [PyPi](https://pypi.org/project/fastcore) (📥 52M / month · 📦 1.3K · ⏱️ 09.09.2026):
  ```
  pip install fastcore
  ```
* [Conda](https://anaconda.org/conda-forge/fastcore) (📥 380K · ⏱️ 09.09.2026):
  ```
  conda install -c conda-forge fastcore
  ```

</details>
<details><summary><b><a href="https://github.com/boppreh/keyboard">keyboard</a></b> (🥉28 ·  ⭐ 3.8K) - Hook and simulate global keyboard events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

* [GitHub](https://github.com/boppreh/keyboard) ⭐ 3,967 | 🐛 414 | 🌐 Python | 📅 2026-07-10 (👨‍💻 41 · 🔀 430 · 📦 27K):

  ```
  git clone https://github.com/boppreh/keyboard
  ```
* [PyPi](https://pypi.org/project/keyboard) (📥 640K / month · 📦 720 · ⏱️ 23.03.2020):
  ```
  pip install keyboard
  ```
* [Conda](https://anaconda.org/conda-forge/keyboard) (📥 86K · ⏱️ 08.09.2026):
  ```
...
* [GitHub](https://github.com/copier-org/copier) ⭐ 3,564 | 🐛 144 | 🌐 Python | 📅 2026-09-07 (👨‍💻 130 · 🔀 270 · 📦 2.1K):

  ```
  git clone https://github.com/copier-org/copier
  ```
* [PyPi](https://pypi.org/project/copier) (📥 1.8M / month · 📦 420 · ⏱️ 07.09.2026):
  ```
  pip install copier
  ```
...
* [GitHub](https://github.com/arsenetar/send2trash) ⭐ 312 | 🐛 40 | 🌐 Python | 📅 2026-06-16 (👨‍💻 20 · 🔀 47 · 📦 320K):

  ```
  git clone https://github.com/arsenetar/send2trash
  ```
* [PyPi](https://pypi.org/project/send2trash) (📥 37M / month · 📦 710 · ⏱️ 14.01.2026):
  ```
...
* [GitHub](https://github.com/BoboTiG/python-mss) ⭐ 1,281 | 🐛 43 | 🌐 Python | 📅 2026-09-07 (👨‍💻 31 · 🔀 110 · 📦 14K):

  ```
  git clone https://github.com/BoboTiG/python-mss
  ```
* [PyPi](https://pypi.org/project/mss) (📥 3.2M / month · 📦 650 · ⏱️ 23.04.2026):
  ```
  pip install mss
  ```
...
* [GitHub](https://github.com/pyscaffold/pyscaffold) ⭐ 2,262 | 🐛 37 | 🌐 Python | 📅 2026-08-31 (👨‍💻 59 · 🔀 190):

  ```
  git clone https://github.com/pyscaffold/pyscaffold
  ```
* [PyPi](https://pypi.org/project/pyscaffold) (📥 2.4M / month · 📦 46 · ⏱️ 23.09.2024):
  ```
...
* <b>[powerline-shell](https://github.com/b-ryan/powerline-shell) ⭐ 6,288 | 🐛 131 | 🌐 Python | 📅 2024-03-19</b> (🥉21 ·  ⭐ 5.9K · 💀) - A beautiful and useful prompt for your shell. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
* <b>[pycparser](https://github.com/eliben/pycparser) ⭐ 3,568 | 🐛 32 | 🌐 Python | 📅 2026-09-10</b> (🥈30 ·  ⭐ 3.6K) - Complete C99 parser in pure Python. <code>❗Unlicensed</code>
...
* <b>[catalogue](https://github.com/explosion/catalogue) ⭐ 183 | 🐛 6 | 🌐 Python | 📅 2026-03-27</b> (🥉25 ·  ⭐ 180 · 💀) - Super lightweight function registries for your library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* <b><a href="https://openpyxl.readthedocs.io">openpyxl</a></b> (🥉25 ·  ⭐ 12) - A Python library to read/write Excel 2010 xlsx/xlsm files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
* [**awesome-python**](https://github.com/vinta/awesome-python) ⭐ 319,739 | 🐛 18 | 🌐 Python | 📅 2026-09-01: A curated list of awesome Python frameworks, libraries, software and resources.
* [**best-of-ml-python**](https://github.com/ml-tooling/best-of-ml-python) ⭐ 23,797 | 🐛 57 | 📅 2026-09-10: A ranked list of awesome machine learning Python libraries.
* [**best-of-web-python**](https://github.com/ml-tooling/best-of-web-python) ⭐ 2,758 | 🐛 17 | 📅 2026-09-03: A ranked list of awesome Python libraries for web development.
* [**best-of-python-dev**](https://github.com/ml-tooling/best-of-python-dev) ⭐ 1,300 | 🐛 31 | 🌐 Python | 📅 2026-09-10: A ranked list of awesome Python developer tools and libraries.
...
* Open an issue by selecting one of the provided categories from the [issue page](https://github.com/ml-tooling/best-of-python/issues/new/choose) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10 and fill in the requested information.
* Modify the [projects.yaml](https://github.com/ml-tooling/best-of-python/blob/main/projects.yaml) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10 with your additions or changes, and submit a pull request. This can also be done directly via the [Github UI](https://github.com/ml-tooling/best-of-python/edit/main/projects.yaml) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10.

If you like to contribute to or share suggestions regarding the project metadata collection or markdown generation, please refer to the [best-of-generator](https://github.com/best-of-lists/best-of-generator) ⭐ 110 | 🐛 15 | 🌐 Python | 📅 2025-08-31 repository. If you like to create your own best-of list, we recommend to follow [this guide](https://github.com/best-of-lists/best-of/blob/main/create-best-of-list.md) ⭐ 1,895 | 🐛 22 | 📅 2026-09-03.

For more information on how to add or update projects, please read the [contribution guidelines](https://github.com/ml-tooling/best-of-python/blob/main/CONTRIBUTING.md) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10. By participating in this project, you agree to abide by its [Code of Conduct](https://github.com/ml-tooling/best-of-python/blob/main/.github/CODE_OF_CONDUCT.md) ⭐ 4,596 | 🐛 51 | 📅 2026-09-10.
